  ...
  <div id="container">
    ...
    <div id="rightCon">
      ...
      <div id="pgTit" style="background:url(../images2/foundation/stl_bg_site.gif) no-repeat left top;">
        <h3>����Ʈ��</h3>
        <div class="navi"><img src="../images2/foundation/home.gif" width="13" height="11" /> > ����Ʈ��
        </div>
      </div>
      <!-- /pgTit -->
                ...
                <td width="138" height="265" valign="top"  style=" background:url(../images2/sitem/bg.gif) no-repeat;">
                    <table width="138" border="0" cellspacing="0" cellpadding="0" >
                        ...
                        <tr>
                            ...
                            <ul>
<%
        String strSiteMapMenuTitle_ReqSubmit = (strIsRequester !=null && strIsRequester.equals("true")) ? "�ڷ�䱸" : "�ڷ�����";
%>
