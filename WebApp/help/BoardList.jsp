...
<%
		...
		if(strSrchText.equals("") || strSrchText == null){
			//검색 조건이 없을 경우
			objAryBbrdData = objQnaBoard.selectBbrdDataListPerPage(strBbrdID, "0", strCurrentPage, strCountPerPage);

		} else {
			//검색 조건이 있을 경우.
			objAryBbrdData = objQnaBoard.selectBbrdSearchListPerPage(strBbrdID, "0", strCurrentPage,
...
<%
	...
	String strBbrdImgId = (String)objHshBbrdInfo.get("IMG_ID");
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0" class="list01">
								...
								<tr>
										...
										<td style="text-align:left;">											
											<a href="/board/common/BoardList2Content.jsp?strGoToPage=%2Fhelp%2FBoardContent.jsp&strCurrentPage=2&bbrdid=0000000015&dataid=0000003189">
												[공지]SMS문의, 담당자변경 문의시 필독해주세요.!!!!!
											</a>
										</td>
										<td>&nbsp;</td>
										<td>관리자</td>
