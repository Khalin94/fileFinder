...
<form name="formName" method="post" encType="multipart/form-data" action="./RMakeReqInfoWriteProc.jsp"><!--요구 신규정보 전달 -->
      ...
      <div id="contents">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="680" class="list02">
            ...
            <tr>
                ...
                <td height="25" colspan="3">
					<table border="0" cellspacing="0" cellpadding="0" width="100%" height="100%">
						...
						<tr>
							<td style="border:0px;"><span id="textlimit"></span> bytes (2000 bytes 까지만 입력됩니다).</td>
						</tr>
						<tr>
							<td style="border:0px;">* 한글은 1000자, 영문은 2000자에 해당합니다.</td>
						</tr>
					</table>
				</td>
            </tr>
            ...
            <tr>
                <th height="25" width="120">&bull; 제출양식파일 </th>
                <td height="25" width="220" colspan="3">
        ...
        <!-- 리스트 버튼-->
         <div id="btn_all"class="t_right">
			 <span class="list_bt" onclick="javascript:checkFormData();return false;"><a href="#">저장</a></span>
			 <span class="list_bt" onclick="javascript:formName.reset();return false;"><a href="#">취소</a></span>
			 <span class="list_bt" onclick="javascript:gotoList()"><a href="#">요구함 보기</a></span>
