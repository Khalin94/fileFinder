...
<SCRIPT language="JavaScript" src="/js/reqsubmit/reqinfo.js"></SCRIPT>
    ...
    <div id="rightCon">
      ...
      <div id="contents">
        ...
        <span class="list02_tl">요구자료 등록 정보 </span>
		<%
		...
		%>
         <div class="top_btn"><samp>
			 <span class="btn"><a href="javascript:goReqBoxList();")">목록보기</a></span>
			 <span class="btn"><a href="javascript:doDelete('<%= (String)objParams.getParamValue("ReqBoxID") %>')">요구함삭제</a></span>
		 </samp></div>
<form name="viewForm" method="post" action="" style="margin:0px">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="list02">
            <tr>
              <th scope="col" width="100px;">&bull;&nbsp;요구자료 </th>
            ...
            <tr>
             ...
             <tr>
              ...
              <th scope="col">&bull;&nbsp;요구자료이력</th>  <td colspan="3">
              <ul class="list_in">
              <li><span class="tl">&bull;&nbsp;요구함생성일시 :</span> <%=StringUtil.getDate2((String)objRsSH.getObject("REG_DT"))%></li>
              <li><span class="tl">&bull;&nbsp;비전자요구 수신일 :</span> <%=StringUtil.getDate2((String)objRsSH.getObject("LAST_REQ_DOC_SND_DT"))%></li>
              ...
              <li><span class="tl">&bull;&nbsp;제출기한 :</span> <strong><%=StringUtil.getDate((String)objRsSH.getObject("SUBMT_DLN"))%> 24:00</strong></li>
                ...
                <tr>
              <th scope="col">&bull;&nbsp;요구자료설명 </th>   <td colspan="3"><%= objRsSH.getObject("REQ_BOX_DSC") %></td>
            </tr>
        </table>
        <!-- /list view -->
        <div id="btn_all">
             <div class="mi_btn"><a href="javascript:PreReqDocView(viewForm,'<%= (String)objParams.getParamValue("ReqBoxID") %>', '<%= CodeConstants.PRE_REQ_DOC_FORM_101 %>')"><span>요구서 미리 보기</span></a></div>
			 <div class="mi_btn"><a href="<%= strAnsDocPreviewScriptURL %>"><span>답변서 미리 보기</span></a></div>
			 <div class="mi_btn"><a href="<%= strAnsDocURL %>"><span>답변서 발송</span></a></div>
        ...
        <p class="warning mt10">추가하실 답변작성이 있는 경우, 하단의 <추가답변 작성 버튼을 클릭하여 주시기 바랍니다.</p>
        <div id="btn_all" class="t_right" >
        <!-- /리스트 내 검색 -->
			<span class="list_bt"><a href="javascript:goSbmtReqForm()">추가답변 작성</a></span>
			<span class="list_bt"><a href="javascript:viewReqHistory()">요구이력 보기</a></span>
<!--
