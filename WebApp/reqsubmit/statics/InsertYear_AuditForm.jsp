...
<%
	String strUserID = objUerInfo_AuthCheck.getStrUserId();
%>
<html>
...
function fUsrActionInsert(mode, strNew, strStart, strEnd) {
  switch(mode) {   
    case "Insert" :
         if (!fCheckField()) return false;    
       	 form1.action = "InsertYear_AuditProc.jsp?cmd="+mode+"&strNew="+strNew+"&strStart="+strStart+"&strEnd="+strEnd;         	 
      	 form1.submit();
         break;                  
  }
}
...
function fCheckField() {
  with (form1) {
    if (audit_yaer_new.value.length < 4) {
      alert('국감년도를 4자리 숫자로 입력하세요');
      audit_yaer_new.focus();
      return false;
    }
    ...
    <td width="973"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr bgcolor="EDEDED"> 
          <td height="25" colspan="2" align="left" valign="middle">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;홈 
            &gt; 통계 관리 &gt; 서류 요구 제출 통계 &gt; <strong>년도별 국정감사 기간 등록</strong></td>
        </tr> 
        <tr> 
        ...
        <tr> 
          <td align="left" valign="top"></td>
          <td height="30" align="left"> 년도별 국정감사 기간 정보를 등록 할 수 있습니다.</td>
        </tr>
        <tr> 
          <td align="left" valign="top">&nbsp;</td>
          <td align="left" valign="top"><table width="95%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <input type="text" class="textbox" name="audit_yaer_new" maxlength=4 size=4 value="" >			    			    
                </td>
              </tr>
              <tr class="tbl-line"> 
                <td height="1"></td>
              ...
              <tr> 
                ...
                <td height="23" class="td_lmagin">
			  	<input type="text" class="textbox" name="audit_str_day" size="10" maxlength="8" value=""  readonly OnClick="this.select()" OnKeyPress="if ((event.keyCode&lt;48)||(event.keyCode&gt;57)) event.returnValue=false;" OnBlur="javascript:SetFormatDate(this);" >
              ...
              <tr> 
                ...
                <td height="23" class="td_lmagin">
			  	<input type="text" class="textbox" name="audit_end_day" size="10" maxlength="8" value=""  readonly OnClick="this.select()" OnKeyPress="if ((event.keyCode&lt;48)||(event.keyCode&gt;57)) event.returnValue=false;" OnBlur="javascript:SetFormatDate(this);" >
        ...
        <tr> 
          ...
          <td height="35" align="left">
  		  <img src="../image/button/bt_save.gif" width="43"  height="20" border=0 style="cursor:hand" OnClick="javascript:fUsrActionInsert('Insert',form1.audit_yaer_new.value, form1.audit_str_day.value, form1.audit_end_day.value);">
