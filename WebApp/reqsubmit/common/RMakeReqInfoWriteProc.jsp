...
<%
 ...
 /*************************************************************************************************/
  ...
  /** 요구 등록에 필요한 파라 미터 체크.*/
  RMemReqInfoWriteForm objWriteParams =new RMemReqInfoWriteForm();  
...
<%
 ...
 try{
   /********* 대리자 정보 설정 *********/
   MemRequestInfoDelegate objReqInfo=new MemRequestInfoDelegate();   /** 요구함 정보 입력용 */
