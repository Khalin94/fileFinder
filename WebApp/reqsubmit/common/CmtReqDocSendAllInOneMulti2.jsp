...
<%
	...
	<%
			...
			objParams.setParamValue("ReqInfoPageSize", "30"); //요구 목록의 갯수가 15개 이상인 경우 오류가 발생되어 30개까지로 늘려놓음
		...
		String strSmsMsg = "의정자료전자유통시스템에 "+intSuccessCnt+"건의 요구서가 접수되었습니다.[국회사무처]";
		...
		if(objRS != null && objRS.getRecordSize() > 0) {
			while(objRS.next()){
				...
				hashSmsInfo.put("DEPT_NM", tempReqOrganNm); // 2004-04-13 추가 1
