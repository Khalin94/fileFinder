				  ...
				  <div id="contents">
					...
					<!-- 제출 완료 -->
						...
						%>
						 ...
						 <span class="btn"><a href="javascript:viewReqHistory('<%=(String)request.getParameter("ReqInfoID")%>')">요구이력보기</a></span>
						</samp>
					 </div>
					...
					<table border="0" cellspacing="0" cellpadding="0" width="680" class="list02">
						...
						%>
						<tr>
							<th height="25" width="18%">&bull; 등록일시 </th>
							<td height="25" width="32%"><%=StringUtil.getDate2((String)objRsRI.getObject("LAST_REQ_DT"))%></td>
							<th height="25" width="18%">&bull;&nbsp;제출기한</th>
							<td height="25" width="32%"><%=StringUtil.getDate((String)objRsRI.getObject("SUBMT_DLN"))%> 24:00</td>
						</tr>
						<tr>
