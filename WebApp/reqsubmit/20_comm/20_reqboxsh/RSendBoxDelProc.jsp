...
<%
 ...
 try{
   ...
   SendReqBoxDelegate objSReqBox = new SendReqBoxDelegate();
	...
	/********* 데이터 삭제 하기  **************/
   objSReqBox.removeReqFile(strReqBoxID);
   System.out.println("Son11111");
   objSReqBox.removeSubmitFile(strReqBoxID);
   System.out.println("Son22222");
	resultInt = objSReqBox.removeAllRecord(strReqBoxID);
   System.out.println("Son33333");
	blnEditOk =((Boolean)objReqBox.removeRecord(strReqBoxID)).booleanValue();
   System.out.println("Son44444");
