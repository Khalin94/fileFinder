		...
		%>
         ...
         if(!strReqSubmitFlag.equals("004")){ %>
            <%
              ...
              %>
            <span class="btn"><a href="javascript:gotoEditPage()">요구수정</a></span>
                <%}%>
                <%if( objInfoRsSH.getObject("ANS_CNT").equals("0")){ %>
            <span class="btn"><a href="javascript:gotoDeletePage()">요구삭제</a></span>
                <% } %>
         ...
         <%} //end if 001 권한없음에 관련 %>
            ...
            <!-- 요구함 보기 -->
			 <span class="btn"><a href="javascript:gotoBoxView()">요구함보기</a></span>
			 </samp>
		 </div>
		<!--/상단 버튼 끝-->
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="list01">
          <thead>
            <tr>
              ...
              <th scope="col"><a>답 변</a></th>
              <th scope="col"><a>답 변 일</a></th>
            </tr>
          </thead>
          <tbody>
			<%
