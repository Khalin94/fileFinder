...
<!-- 상단 버튼 시작 요구마감, 요구마감 취소, 요구일정 수정, 요구일정 삭제, 목록 -->
         <div class="top_btn">
			<samp>
		<%
		...
		%>
			...
			<!--요구마감 버튼 -->
					 <span class="btn"><a href="#" onclick="javascript:fUsrAction2('reqend',form1.ReqScheId.value);">요구마감</a></span>
			<%}%>
			<% if(strIngStt.equals("002")) { %>
				<% if ( intNatCnt == 0 ) { %>
				 <!--요구마감취소 버튼 -->
					 <span class="btn"><a href="#" onclick="fUsrAction2('reqendback',form1.ReqScheId.value);">요구마감 취소</a></span>
				<%}%>
			<%}%>
			<% if(strIngStt.equals("001")) { %>
			 <!--수정 버튼 -->
					...
					<span class="btn"><a href="#" onclick="fUsrAction2('delet',form1.ReqScheId.value)">요구일정 삭제</a></span>
			<%}%>
					<span class="btn"><a href="#" onclick="fUsrActionBack('back',form1.AuditYear.value);">목록</a></span>
		<%}else{%>
				<span class="btn"><a href="#" onclick="fUsrActionBack('back',form1.AuditYear.value);" >목록</a></span>
		<%}%>
				</samp>
