...
<form  method=post name=PageForm action=ISearch_News_html.jsp >
        <tr valign="top"> 
          ...
          <td align="left"><table width="759" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td height="23" colspan="2" align="left" valign="top"><table width="100%" height="23" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="10%" background="../image/infosearch/bg_infosearch_tit.gif"><span class="title">신문검색</span> </td>
              ...
              <tr> 
			<td height="50" colspan="2" align="left" class="text_s">기사를 제공하는 사이트별로 웹문서를  보실수있습니다. 링크를 클릭하면 해당 사이트로 이동됩니다.</td>
              </tr>
              <tr> 
                    ...
                    <tr> 
                      ...
                      <td width="41%" rowspan="2" align="right" valign="bottom" class="text_s"><table width="20%" border="0" cellspacing="0" cellpadding="0">
                          <tr align="left" valign="bottom"> 
                            <td width="3%"><a href="ISearch_News.jsp?queryText=<%=toMulti(query)%>&deptText=<%=deptText%>&query=<%=query%>"><img src="../image/infosearch/tab_board_over.gif" width="97" height="23" border=0></a></td>
...
%>                                </td>
              ...
              <tr> 
                <td height="40" colspan="2" align="left"><a href="ISearch_News_html.jsp"><img src="../image/button/bt_goFirst.gif" width="67" height="20" border=0></a></td>
              </tr>
              <tr> 
