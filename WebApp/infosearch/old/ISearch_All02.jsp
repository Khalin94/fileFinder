...
<%
	...
	try { //자료제출검색
		...
		System.out.println("ISearch_All02 : "+e.getMessage());
	}
            ...
            <div class="serP">
                ...
                <div class="schBox">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="list02">
						<tr>
							<td colspan="3">
								<ul><li>&bull;&nbsp;<a href="ISearch_All02.jsp?iptName=<%=squery%>&sflag=1">요구제출자료</a><span class="num"> <%=hitCount01%> </span>건</li>
...
<!-- /list view --> <br />
					<br />
					<!-- list -->
					<span class="list01_tl">위원회홈페이지 검색 결과 <span class="list_total">&bull;&nbsp;전체자료수 : <%=hitCount02%>개</span>
...
<%
	if (hitCount02 !=0) {
		String viewHref = "";
		Enumeration enum1 = result02.documents().elements();
