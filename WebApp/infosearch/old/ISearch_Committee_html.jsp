<!--
**      Program Name : ISearch_Committee_html.jsp
**      Program Date : 2004. 05.19.
**      Last    Date : 2004. 05.19.
**      Programmer   : Kim Kang Soo
**      Description  : 상세검색중  위원회홈페이지 html검색
**
...
//숫자파라미터
	...
	if(colls==null) colls = "committee_html";
...
<form  method=post name=PageForm action=ISearch_Committee_html.jsp>
        <tr valign="top"> 
          ...
          <td align="left"><table width="759" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
			<td height="50" colspan="2" align="left" class="text_s">각 위원회에서 관리하는 위원회 홈페이지에 등록된 Html 자료를 웹로봇이 자동으로 수집하여 최근 자료순으로 제공해줍니다.(1주 마다 자료  Update 됩니다.)</td>
              </tr>
              <tr> 
                    ...
                    <tr> 
                      ...
                      <td width="41%" rowspan="2" align="right" valign="bottom" class="text_s"><table width="20%" border="0" cellspacing="0" cellpadding="0">
                          <tr align="left" valign="bottom"> 
                            <td width="3%"><a href="ISearch_Committee.jsp?queryText=<%=toMulti(query)%>&deptText=<%=deptText%>&query=<%=query%>"><img src="../image/infosearch/tab_board_over.gif"  border=0></a></td>
...
%>                                </td>
              ...
              <tr> 
                <td height="40" colspan="2" align="left"><a href="ISearch_Committee_html.jsp"><img src="../image/button/bt_goFirst.gif" width="67" height="20" border=0></a></td>
              </tr>
              <tr> 
