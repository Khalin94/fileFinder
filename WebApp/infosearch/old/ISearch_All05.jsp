						...
						<tr>
							<td colspan="3">
								<ul><li>&bull;&nbsp;<a href="ISearch_All01.jsp?iptName=<%=squery%>&sflag=1">요구제출자료</a><span class="num"> <%=hitCount01%> </span>건</li>
									...
									<li>&bull;&nbsp;<a href="ISearch_All02.jsp?iptName=<%=squery%>&sflag=2">위원회홈페이지</a> <span class="num"><%=hitCount02%> </span> 건</li>
									<%	if (IS_REQUESTER) {//%>
									<li>&bull;&nbsp;<a href="ISearch_All03.jsp?iptName=<%=squery%>&sflag=3">관련기관 웹사이트</a> <span class="num"><%=hitCount03%> </span> 건</li>
...
<!-- /list view --> <br />
					<br />
					<!-- list -->
					<span class="list01_tl">회의자료 검색 결과 <span class="list_total">&bull;&nbsp;전체자료수 : <%=hitCount05%>개</span>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="list01">
				  <thead>
					<tr align="center" class="td_top">
                      ...
                      <th scope="col"><a href="javascript:SearchPageForm('DLBRT_ORGAN_NM','<%if(sortMethod.equals(" asc ")){out.println(" desc ");}else{out.println(" asc ");}%>');">담당기관 <%if(sortField.equals("DLBRT_ORGAN_NM")){if(sortMethod.equals(" asc ")){out.println(" ▼ ");}else{out.println(" ▲ ");}}%></a></th>
                      <th scope="col"><a href="javascript:SearchPageForm('DATA_NM','<%if(sortMethod.equals(" asc ")){out.println(" desc ");}else{out.println(" asc ");}%>');">제출내용<%if(sortField.equals("DATA_NM")){if(sortMethod.equals(" asc ")){out.println(" ▼ ");}else{out.println(" ▲ ");}}%></a></th>
                      <th scope="col">파일</th>
                      <th scope="col"><a href="javascript:SearchPageForm('REG_DT','<%if(sortMethod.equals(" asc ")){out.println(" desc ");}else{out.println(" asc ");}%>');">등록일<%if(sortField.equals("REG_DT")){if(sortMethod.equals(" asc ")){out.println(" ▼ ");}else{out.println(" ▲ ");}}%></a></th>
                    </tr>
				   </thead>
<%
	if (hitCount05 !=0) {
...
%>
						<tr  align="center">
						  <td height="22" align="center" colspan="6">검색된 결과가 없습니다.</td>
						</tr>
