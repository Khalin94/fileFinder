...
<%
	...
	try {//자료제출검색
		...
		System.out.println("ISearch_All03 : "+e.getMessage());
	}
...
<!-- /검색창  -->
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="list02">
						<tr>
							<td colspan="3">
								<ul><li>&bull;&nbsp;<a href="ISearch_All03.jsp?iptName=<%=squery%>&sflag=1">요구제출자료</a><span class="num"> <%=hitCount01%> </span>건</li>
...
<!-- /list view --> <br />
					<br />
					<!-- list -->
					<span class="list01_tl">관련기관 웹사이트 검색 결과<span class="list_total">&bull;&nbsp;전체자료수 : <%=hitCount03%>개</span>
...
<%
	if (hitCount03 !=0) {
		String viewHref = "";
		Enumeration enum1 = result03.documents().elements();
...
%>
                    <tr>
                      <td  height="22" align="center">검색된 결과가 없습니다.</td>
                    <tr>
<%
	}
%>
