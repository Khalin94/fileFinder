...
<div id="top_menu">
  ...
  <ul class="depth1">
    <li>
      <h2><img src="/images2/common/topMenu01.gif" alt="나의페이지" onmouseover="MM_showHideLayers('depth2_1','','show','depth2_2','','hide','depth2_2_sub','','hide','depth2_3','','hide','depth2_4','','hide','depth2_5','','hide')" onmouseout="MM_showHideLayers('depth2_1','','hide','depth2_2','','hide','depth2_2_sub','','hide','depth2_3','','hide','depth2_4','','hide','depth2_5','','hide')" /></h2>
    </li>
    <li>
      <h2><%if("true".equals(strTopIsRequesterGbn)){ %><img src="/images2/common/topMenu02.gif"  alt="자료요구" onmouseover="MM_showHideLayers('depth2_1','','hide','depth2_2','','show','depth2_2_sub','','hide','depth2_3','','hide','depth2_4','','hide','depth2_5','','hide')" onmouseout="MM_showHideLayers('depth2_1','','hide','depth2_2','','hide','depth2_2_sub','','hide','depth2_3','','hide','depth2_4','','hide','depth2_5','','hide')" /><%}else{%><img src="/images2/common/topMenu02_2.gif"  alt="자료제출" onmouseover="MM_showHideLayers('depth2_1','','hide','depth2_2','','hide','depth2_2_sub','','show','depth2_3','','hide','depth2_4','','hide','depth2_5','','hide')" onmouseout="MM_showHideLayers('depth2_1','','hide','depth2_2','','hide','depth2_2_sub','','hide','depth2_3','','hide','depth2_4','','hide','depth2_5','','hide')" /><%}%></h2>
    </li>
    <li>
      <h2><img src="/images2/common/topMenu03.gif" alt="정보검색" onmouseover="MM_showHideLayers('depth2_1','','hide','depth2_2','','hide','depth2_2_sub','','hide','depth2_3','','show','depth2_4','','hide','depth2_5','','hide')" onmouseout="MM_showHideLayers('depth2_1','','hide','depth2_2','','hide','depth2_2_sub','','hide','depth2_3','','hide','depth2_4','','hide','depth2_5','','hide')" /></h2>
    </li>
    <li>
      <h2><img src="/images2/common/topMenu04.gif" alt="주요자료" onmouseover="MM_showHideLayers('depth2_1','','hide','depth2_2','','hide','depth2_2_sub','','hide','depth2_3','','hide','depth2_4','','show','depth2_5','','hide')" onmouseout="MM_showHideLayers('depth2_1','','hide','depth2_2','','hide','depth2_2_sub','','hide','depth2_3','','hide','depth2_4','','hide','depth2_5','','hide')" /></h2>
    </li>
    <li>
      <h2><img src="/images2/common/topMenu05.gif" alt="이용안내"   onmouseover="MM_showHideLayers('depth2_1','','hide','depth2_2','','hide','depth2_2_sub','','hide','depth2_3','','hide','depth2_4','','hide','depth2_5','','show')" onmouseout="MM_showHideLayers('depth2_1','','hide','depth2_2','','hide','depth2_2_sub','','hide','depth2_3','','hide','depth2_4','','hide','depth2_5','','hide')" /></h2>
    </li>
    <!-- 상단검색 -->
    <li class="search">
  ...
  <div id="dep2_position" >
    ...
    <div id="depth2_1" onmouseover="MM_showHideLayers('depth2_1','','show','depth2_2','','hide','depth2_2_sub','','hide','depth2_3','','hide','depth2_4','','hide','depth2_5','','hide')" onmouseout="MM_showHideLayers('depth2_1','','hide','depth2_2','','hide','depth2_2_sub','','hide','depth2_3','','hide','depth2_4','','hide','depth2_5','','hide')">
      <p class="my"><a href="/activity/MyReqSubmitSearch.jsp"><img src="/images2/common/topMenu01_on.gif" alt="나의페이지" /></a></p>
	...
	if(objAryTopMenu != null){
		for(int i=0;i < objAryTopMenu.size();i++){
			...
			if(strTopMenuNM.equals("개인정보변경")){
				strTopGoURL = "javascript:TryLogin();";
			}
...
%>
    ...
    <div id="depth2_2" onmouseover="MM_showHideLayers('depth2_1','','hide','depth2_2','','show','depth2_2_sub','','hide','depth2_3','','hide','depth2_4','','hide','depth2_5','','hide')" onmouseout="MM_showHideLayers('depth2_1','','hide','depth2_2','','hide','depth2_2_sub','','hide','depth2_3','','hide','depth2_4','','hide','depth2_5','','hide')">
    <p class="req"><a href="/reqsubmit/10_mem/20_reqboxsh/10_make/RMakeReqBoxList.jsp"><img src="/images2/common/topMenu02_on.gif" alt="자료요구" /></a></p>
    <%}else{ %>
    ...
    <div id="depth2_2_sub" onmouseover="MM_showHideLayers('depth2_1','','hide','depth2_2','','hide','depth2_2_sub','','show','depth2_3','','hide','depth2_4','','hide','depth2_5','','hide')" onmouseout="MM_showHideLayers('depth2_1','','hide','depth2_2','','hide','depth2_2_sub','','hide','depth2_3','','hide','depth2_4','','hide','depth2_5','','hide')">
      <p class="sub"><a href="/reqsubmit/10_mem/20_reqboxsh/10_make/SMakeReqBoxList.jsp"><img src="/images2/common/topMenu02_2_on.gif" alt="자료제출" /></a></p>
    <%}%>
...
%>
    ...
    <div id="depth2_3" onmouseover="MM_showHideLayers('depth2_1','','hide','depth2_2','','hide','depth2_2_sub','','hide','depth2_3','','show','depth2_4','','hide','depth2_5','','hide')" onmouseout="MM_showHideLayers('depth2_1','','hide','depth2_2','','hide','depth2_2_sub','','hide','depth2_3','','hide','depth2_4','','hide','depth2_5','','hide')" >
      <p class="ser"><a href="/infosearch/ISearch_All01.jsp"><img src="/images2/common/topMenu03_on.gif" alt="정보검색" /></a></p>
...
%>
    ...
    <div id="depth2_4" onmouseover="MM_showHideLayers('depth2_1','','hide','depth2_2','','hide','depth2_2_sub','','hide','depth2_3','','hide','depth2_4','','show','depth2_5','','hide')" onmouseout="MM_showHideLayers('depth2_1','','hide','depth2_2','','hide','depth2_2_sub','','hide','depth2_3','','hide','depth2_4','','hide','depth2_5','','hide')">
      <p class="boa"><a href="/board/BoardList.jsp?bbrdid=0000000012"><img src="/images2/common/topMenu04_on.gif" alt="주요자료" /></a></p>
...
%>
    ...
    <div id="depth2_5" onmouseover="MM_showHideLayers('depth2_1','','hide','depth2_2','','hide','depth2_2_sub','','hide','depth2_3','','hide','depth2_4','','hide','depth2_5','','show')" onmouseout="MM_showHideLayers('depth2_1','','hide','depth2_2','','hide','depth2_2_sub','','hide','depth2_3','','hide','depth2_4','','hide','depth2_5','','hide')">
      <p class="info"><a href="/help/SystemIntroduction.jsp"><img src="/images2/common/topMenu05_on.gif" alt="이용안내" /></a></p>
