  ...
  <ul class="depth1">
    ...
    <li>
      <h2>
      	 ...
      	 <img src="/images2/common/topMenu02.gif"  alt="자료요구" onmouseover="MM_showHideLayers('depth2_1','','hide','depth2_2','','show','depth2_2_sub','','hide','depth2_3','','hide','depth2_4','','hide','depth2_5','','hide')" onmouseout="MM_showHideLayers('depth2_1','','hide','depth2_2','','hide','depth2_2_sub','','hide','depth2_3','','hide','depth2_4','','hide','depth2_5','','hide')" />
         <%}else{%>
         <img src="/images2/common/topMenu02_2.gif"  alt="자료제출" onmouseover="MM_showHideLayers('depth2_1','','hide','depth2_2','','hide','depth2_2_sub','','show','depth2_3','','hide','depth2_4','','hide','depth2_5','','hide')" onmouseout="MM_showHideLayers('depth2_1','','hide','depth2_2','','hide','depth2_2_sub','','hide','depth2_3','','hide','depth2_4','','hide','depth2_5','','hide')" />
         <%}%>
      </h2>
    </li>
    <li>
...
%>
    ...
    <p class="req">
    	<a href="/reqsubmit/10_mem/20_reqboxsh/10_make/RMakeReqBoxList.jsp">
    		<img src="/images2/common/topMenu02_on.gif" alt="자료요구" />
    	</a>
    </p>
    <%}else{ %>
