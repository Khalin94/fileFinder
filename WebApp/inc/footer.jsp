...
<%
	...
	for(int i=0; i<objCommittArry.size(); i++){
        ...
        if (strOrganNmLeft.equals("국회운영위원회")){
            ...
            url = "http://committee.na.go.kr/intro.html";
        }
        if (!url.equals("")){
%>
...
%>
                        ...
                        <option value="#">::: 국회정보시스템</option>
                          ...
                          <option value="처http://www.nanet.go.kr/main.jsp">국회도서관</option>
