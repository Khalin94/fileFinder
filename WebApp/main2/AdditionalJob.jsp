...
%>
		<table width="184px" border="0" cellspacing="0" cellpadding="0">
			...
			%>
			<tr>
				<td ><span class="left">&bull;&nbsp;<a href="<%=strTempUrl%>">미제출자료&nbsp;</a><span class="num"><%=nads.lib.reqsubmit.util.HashtableUtil.getEmptyIfNull(objMainCntHashTop,"DIFF_SUM","0")%></span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&bull;&nbsp;기한경과자료&nbsp;<span class="num"><%=nads.lib.reqsubmit.util.HashtableUtil.getEmptyIfNull(objMainCntHashTop,"DELAY_SUBMT","0")%></span></span></td>
			</tr>
		</table>
	</form>