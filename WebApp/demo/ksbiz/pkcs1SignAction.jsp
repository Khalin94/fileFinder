...
<%
	...
	String ksbizSigner = request.getParameter("ksbizSigner");
	String ksbizData = request.getParameter("ksbizData");
	String ksbizVidRandom = request.getParameter("ksbizVidRandom");
	String dataEncoding = request.getParameter("encoding");
	String version = "";
	String serialNum = "";
	String signaturealg = "";
	String datebefore = "";
	...
	try 
	{
		...
		/*
		 * PKCS1 검증 시 원문데이터 Charset 설정
		 * EUC-KR : 1
		 * utf-8  : 2
		 */
		if("euckr".equals(dataEncoding)){
			iDataEncoding = 1;
		}
		System.out.println("signData: " + signData);		
		System.out.println("ksbizData: " + ksbizData);		
		System.out.println("ksbizSigner: " + ksbizSigner);		
		ksobj.verifyPKCS1(signData, ksbizData, ksbizSigner, iDataEncoding);
