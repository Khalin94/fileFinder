...
<div id="wrapper" style="width:100%;">
	...
	<a href="#" onclick="KeySharpBiz.setLang('JPN');return false;">일본어</a>
   	<br/>
   	<form id="inputform" name="inputform" method="post" action="loginAction.jsp">
   		<h4>◆ 출력값</h4>
		- 전자서명 메시지<br/>
		...
		<button onclick="KeySharpBiz.autoLogin(document.getElementById('inputform'), complete_sign);return false;">인증서 로그인</button>
