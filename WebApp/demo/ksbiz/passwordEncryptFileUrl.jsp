...
<div id="wrapper" style="width:100%;">
	...
	<div style="padding:30px 70px" >
	  <h2>파일 패스워드 업로드 </h2>
	<form name="upload">
		업로드 URL : <input type="text" id="dataFile" name="dataFile" value="/demo/fileUpload.jsp" style="width:400px"/><br/>
	</form>	
	<button onclick="KeySharpBiz.passwordEncryptFileUrl(document.upload.dataFile.value, upload_complete)">파일 업로드</button><br/>	
