...
<div id="wrapper" style="width:100%;">
	...
	<h4>◆ 입력값</h4>
    <form id="inputform" name="inputform" method="post" action="signOcspCrlAction.jsp">
    - 서명원문<br>
	...
	<button onclick="KeySharpBiz.sign(document.getElementById('plain').value, complete_sign);return false">전자서명</button>
	<button onclick="KeySharpBiz.sign(document.getElementById('plain').value, complete_sign, {cacheCertFilter:false, cacheCert:false});return false;">전자서명(모든 인증서표시)</button>
	<button onclick="KeySharpBiz.sign(document.getElementById('plain').value, {complete:complete_sign_context, context:'String, Object 전달가능'});return false;">전자서명(콜백에 context 사용)</button>
