...
<%
	...
	if(strBbrdID.equals("0000000012")){
						...
						<table cellspacing="0" cellpadding="0" class="list03">
							...
							<tr>
								...
								<td height="310" valign="top">
									<p>
									<textarea name="txtCont"style="width:450px; height:250px;"><%=strCont%></textarea>
							...
							<%
								for(int i = 0; i < intBbrdFileCnt; i++) {
									...
									out.println("<input name='showfile" + i + "' value='' readonly style='WIDTH: 300px'>");
									out.println("<input type='file' name='upfile" + i + "' onChange='javascript:searchFile(this.form, this);' style='WIDTH: 90px'><br>");
