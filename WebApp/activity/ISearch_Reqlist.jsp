...
**      Description  : 자료제출검색의 요구기관찾기를 우편번호 인터페이스로 구현
**
...
<%@ include file="/infosearch/utils.jsp" %>
<html>
<head>
<title>요구기관 찾기</title>
...
<script language="JavaScript">
 function ReturnCode(str){
	var organInfo = str.split("/");
	opener.document.formName.req_organ_select_id.value=organInfo[0];	// 기관ID
	opener.document.formName.req_organ_select.value=organInfo[1];	// 기관명
	window.close();	
 }
 function search()
{
...
//	if (!ans_list.equals("")){
		...
		try {//요구기관 우편번호식 찾기
			...
			objArr = objCMD.selectReq_Organ_Keyword(ans_list);
...
//	}
%>
<form  method=post name=PageForm action=./ISearch_Reqlist.jsp >

<input type="hidden" name="organInfo">
...
<table width="500" border="0" cellspacing="0" cellpadding="0" scrolling="yes">
  ...
  <tr> 
    ...
    <td height="25" valign="middle"><img src="../image/infosearch/icon_infosearch_soti.gif" width="9" height="9" align="absmiddle"> 
      <span class="soti_infosearch"> 요구기관 찾기</span></td>
  </tr>
  <tr> 
    <td height="10"></td>
    <td height="10"></td>
          ...
          <td height="35" align="center" bgcolor="#F3F3F3"><table width="75%" border="0" cellspacing="3" cellpadding="0">
              <tr> 
                <td width="19%" align="left"><img src="../image/common/icon_nemo_gray.gif" width="3" height="6"> 
                  <strong>요구기관<%=ans_list%></strong></td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td height="23" align="left">&nbsp;요구기관을 Click하세요.</td>
  </tr>
  <tr> 
    <td width="15">&nbsp;</td>
    <td height="23" valign="top"><table width="97%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td height="22" align="center" class="td_top">요구기관</td>
        </tr>
        <tr height="1"> 
...
%>
        <tr onMouseOver="this.style.backgroundColor='#FCFDF0'" onMouseOut="this.style.backgroundColor=''"> 
          <td height="25" class="td_lmagin"><a href="javascript:ReturnCode('<%=objHashBSorts.get("ORGAN_ID")%>/<%=objHashBSorts.get("ORGAN_NM")%>')"><%=objHashBSorts.get("ORGAN_NM")%></a></td>
        </tr>
<%}%>
        <tr class="tbl-line"> 
          <td height="2"></td>
