...
<%
	ArrayList objRelArry = new ArrayList();

	try{
		nads.dsdm.app.activity.useritet.UserItetDelegate objUserItetDelegateRel = new nads.dsdm.app.activity.useritet.UserItetDelegate();
		objRelArry = objUserItetDelegateRel.selectWebsiteinfo() ;
            ...
            <thead>
              <tr>
                ...
                <th scope="col"><a>등록일자</a></th>
                    ...
                    <%
						if(objRelArry.size() != 0){

							for (int i = 0; i < objRelArry.size(); i++) {
								Hashtable objRelHt = (Hashtable)objRelArry.get(i);

								String strRelTitle = (String)objRelHt.get("TITLE");  //제목
								String strRelUrl = (String)objRelHt.get("URL");       //URL
								String strRelGroupNm = (String)objRelHt.get("GROUPNAME");  //출처
								String strRelRegdate = nads.lib.util.ActComm.makeDate((String)objRelHt.get("GETDATE"));  //등록일자
					%>
            <tbody>
              <tr>
                <td><%=Integer.toString(i+1)%></td>
                <td style="text-align:left;"><%=strRelGroupNm%></td>
                <td><a href="javascript:fun_winopen('<%=strRelUrl%>', '관련기관사이트검색')"><%=strRelTitle%></a></td>
                <td><%=strRelRegdate%></td>
              </tr>
            </tbody>
 ...
 <tr>
                 ...
                 <td colspan="2" align="left" valign="top"><table width="759" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr onMouseOver="this.style.backgroundColor='#FCFDF0'" onMouseOut="this.style.backgroundColor=''">
                      ...
                      <td height="22" align="center"><%=strRelGroupNm%></td>
                      <td height="22" class="td_lmagin"><a href="javascript:fun_winopen('<%=strRelUrl%>', '관련기관사이트검색')"><%=strRelTitle%></a></td>
                      <td height="22" align="center"><%=strRelRegdate%></td>
                    </tr>
                    <tr class="tbl-line">
                      <td height="1"></td>
                      <td height="1"></td>
