...
<!-- kSign Client Toolkit ActiveX -->
<object id="AxKCASE"  classid="CLSID:49E90C74-4A36-469d-91F8-2BBDE9E6EAAD"
	codebase="/cab/AxNAROKPPD(3.1.0.1).cab#Version=3,1,0,1" width= "1" height= "1">
</object>

<!-- MSXML3 Parser 설치 -->
<OBJECT ID="msxml3p" codebase='./../msxml3p.cab#version=8,40,9419,0' WIDTH="5" HEIGHT="5" CLASSID='clsid:3D813DFE-6C91-4A4E-8F41-04346A841D9C' type="application/x-oleobject">
</OBJECT>

<form name="frmNAFSQna" method="post" action="http://nafs.assembly.go.kr:82/Channel">
<input type="hidden" name="task" value="com.QustBrd.command.PT_QustBrdR10Cmd">
<input type="hidden" name="crud" value="R">
<input type="hidden" name="qust_bltn_id" value="">
<input type="hidden" name="hupper_bltn_id" value="">
