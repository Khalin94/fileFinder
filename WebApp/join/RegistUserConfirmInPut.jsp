...
//		System.out.println("=========== vidRandom :: " + vidRandom);
		...
		//if(!tmpCertDn.equals("") && tmpCertDn.equals(request.getParameter("CERT_DN"))){
		if(!"".equals(objHshReqUserInfo.get("CERT_DN"))){
...
//	String strOrganNo =  objHshReqUserInfo.get("ORGAN_NO") != null ?  (String)objHshReqUserInfo.get("ORGAN_NO"):"";
	...
	System.out.println("nUserResult :  " + nUserResult);
        ...
        <div class="user_con"> <br />
            ...
            <table border="0" cellspacing="0" cellpadding="0" class="list03" >
                ...
                <tr>
                    ...
                    <td height="25">
					<input name="ORGAN_ID" type="hidden" style="WIDTH: 220px" value="<%=objHshReqUserInfo.get("ORGAN_ID")%>"> 
					<input name="ORGAN_NM" type="hidden" style="WIDTH: 220px" value="<%=objHshReqUserInfo.get("ORGAN_NM")%>"> 
			   ...
			   %>
                ...
                <tr>
					...
					<input maxlength="7" name="POST_CD1" readonly style="width:60px" value="<%=strPostCd%>"/>
                ...
                <tr>
                    ...
                    <td height="25"><input maxlength="100" name="JUSO1" readonly  style="width:350px;" value="<%=strJuso1%>"/></td>
