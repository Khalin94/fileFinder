...
<%
	...
	String strJuminNo = request.getParameter("juminNo")==null?"":request.getParameter("juminNo") ;

	strJuminNo = new String(objBase64Code.decode(strJuminNo));
			 ...
			 &nbsp;&nbsp;<input type=HIDDEN name="CERT_DN" class="textfield" VALUE="<%=request.getParameter("CERT_DN")%>">
              ...
              <tr>
                <td colspan="2" class="td_gray1"><img src="../image/common/icon_nemo_gray.gif" width="3" height="6">
                  부서명</td>
                <td height="25" colspan="2" class="td_lmagin"><input name="DEPT_NM" type="text" class="textfield" style="WIDTH: 300px" VALUE=<%=objHshReqUserInfo.get("DEPT_NM")%> readonly></td>
              </tr>
              <tr class="tbl-line">
                <td height="1"></td>
                <td height="1"></td>
              ...
              <tr>
                <td height="25" colspan="2" class="td_gray1"><img src="../image/common/icon_nemo_gray.gif" width="3" height="6">
                  직위명<font color="990033">*</font></td>
                <td height="25" colspan="2" class="td_lmagin"><input name="GRD_NM" type="text" class="textfield" style="WIDTH: 300px" VALUE="<%=objHshReqUserInfo.get("GRD_NM")%>"  readonly></td>
              </tr>
              <tr class="tbl-line">
                <td height="1"></td>
                <td height="1"></td>
              ...
              <tr>
                <td height="25" colspan="2" class="td_gray1"><img src="../image/common/icon_nemo_gray.gif" width="3" height="6">
                  직급명<font color="990033">*</font></td>
                <td height="25" colspan="2" class="td_lmagin"><input name="POSI_NM" type="text" class="textfield" style="WIDTH: 300px" VALUE="<%=objHshReqUserInfo.get("POSI_NM")%>"  readonly></td>
              </tr>
              <tr class="tbl-line">
                <td height="1"></td>
                <td height="1"></td>
              ...
              <tr>
                ...
                <td height="25" colspan="2" class="td_lmagin"><input name="EMAIL" type="text" class="textfield" style="WIDTH: 300px" VALUE=<%=objHshReqUserInfo.get("EMAIL")%> readonly></td>
              </tr>
              <tr class="tbl-line">
                <td height="1"></td>
                <td height="1"></td>
			  ...
			  %>
                ...
                <td height="25" colspan="2" class="td_lmagin"><input name="OFFICE_TEL1" type="text" class="textfield" style="WIDTH: 30px" maxlength=3 VALUE=<%=strTel1%> >
                  -
                  <input name="OFFICE_TEL2" type="text" class="textfield" style="WIDTH: 30px" maxlength=4 VALUE=<%=strTel2%>  readonly>
                  -
                  <input name="OFFICE_TEL3" type="text" class="textfield" style="WIDTH: 40px"  maxlength=4 VALUE=<%=strTel3%>  readonly></td>
              </tr>
              <tr>
			  ...
			  %>
                ...
                <td height="25" colspan="2" class="td_lmagin"><input name="FAX_NO1" type="text" class="textfield" style="WIDTH: 30px" maxlength=3 value=<%=strFax1%>  readonly>
                  -
                  <input name="FAX_NO2" type="text" class="textfield" style="WIDTH: 30px"  maxlength=4 value=<%=strFax2%>  readonly>
                  -
                  <input name="FAX_NO3" type="text" class="textfield" style="WIDTH: 40px"  maxlength=4 value=<%=strFax3%>  readonly></td>
              </tr>
              <tr>
                <td height="1" class="tbl-line"></td>
                <td height="1" class="tbl-line"></td>
			  ...
			  %>
                ...
                <td height="25"  class="td_gray1"><img src="../image/common/icon_nemo_gray.gif" width="3" height="6">
				  ...
				  <input type=hidden name="CPHONE" VALUE=<%=strCphone%>  readonly>
                <td height="25" colspan="2" class="td_lmagin"><select name="CPHONE1" class="select" >
                  ...
                  -
                  <input name="CPHONE2" type="text" class="textfield" style="WIDTH: 30px" maxlength=4 value=<%=strCphone2%>  readonly>
                  -
                  <input name="CPHONE3" type="text" class="textfield" style="WIDTH: 40px" maxlength=4 value=<%=strCphone3%>  readonly></td>
              </tr>
              <tr>
                <td height="1" class="tbl-line"></td>
                <td height="1" class="tbl-line"></td>
              ...
              <tr>
				...
				%>
					...
					<input name="POST_CD1" type="text" class="textfield" style="WIDTH: 30px" value=<%=strPostCd1%>  readonly>
                  -
                  <input name="POST_CD2" type="text" class="textfield" style="WIDTH: 30px" maxlength=3 value=<%=strPostCd2%>  readonly>
              ...
              <tr>
                ...
                <td height="25" colspan="2" class="td_lmagin"><input name="JUSO2" type="text" class="textfield" style="WIDTH: 300px" VALUE=<%=strJuso2%>  readonly></td>
              </tr>
              <tr>
                <td height="1" class="tbl-line"></td>
                <td height="1" class="tbl-line"></td>
...
<%
		...
		for(int i=0; i < objChargeInfoArry.size(); i++){
			...
			if( strMsortCd.equals("999")){
%>
                        <input name="mchr<%=Integer.toString(i)%>" type="checkbox" value="<%=strMsortCd%>"    <%=strChecked%> onclick="makeTextBox(this,'MRK')"  disabled><%=strCdNm%>&nbsp;&nbsp;<br>
...
%>
                        <input name="mchr<%=Integer.toString(i)%>" type="checkbox" value="<%=strMsortCd%>"    <%=strChecked%>  <%=strDisabled%> onclick="fun_check(this)"  disabled><%=strCdNm%>&nbsp;&nbsp;
...
%>
						...
						<!-- 주업무 한글명 -->
						<input type='hidden' name='MchrWord' class='textfield' value="<%=strMchrWord+" "+ strRemark %>">
                      </td>
                    </tr>
...
<%
		...
		for(int i=0; i < objChargeInfoArry.size(); i++){
			...
			if( strMsortCd.equals("999")){
%>
                        <input name="schr<%=Integer.toString(i)%>" type="checkbox" value="<%=strMsortCd%>"    <%=strChecked%> onclick="makeTextBox(this,'SRK')"  disabled><%=strCdNm%>&nbsp;&nbsp;<br>
...
%>
                        <input name="schr<%=Integer.toString(i)%>" type="checkbox" value="<%=strMsortCd%>"    <%=strChecked%>  <%=strDisabled%> onclick="fun_checkm(this)"  disabled><%=strCdNm%>&nbsp;&nbsp;
...
%>
					<!-- 부업무 한글명 -->
					<input type='hidden' name='SchrWord' class='textfield' value="<%=strSchrWord+" "+ strRemark %>" >
...
%>
			...
			%>
              ...
              <tr>
			  <%
				String strOffiSignFlag = (String)objHshReqUserInfo.get("OFFISIGN_FLAG");
			  %>
                <td height="25" colspan="2" class="td_gray1"><img src="/image/common/icon_nemo_gray.gif" width="3" height="6">
                  공인전자서명 신청여부<font color="990033">*</font></td>
                <td height="25" colspan="2" class="td_lmagin">
				<input type="radio" name="OFFISIGN_FLAG" value="Y" <%=strOffiSignFlag.equals("Y")?"checked":""%> disabled>예&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <input type="radio" name="OFFISIGN_FLAG" value="N" <%=strOffiSignFlag.equals("N")?"checked":""%> disabled>
                  아니오<br>
				("행자부인증서"나 "국회특수목적용인증서"가 없을 경우 신청)</td>
              </tr>
              ...
              <tr>
                <td height="65" colspan="2" class="td_gray1"><img src="../image/common/icon_nemo_gray.gif" width="3" height="6">
                  자기소개</td>
                <td height="65" colspan="2" class="td_box" ><textarea name="REMARK" wrap="hard" class="textfield" style="WIDTH: 100% ; height: 60"  readonly><%=objHshReqUserInfo.get("REMARK")%></textarea></td>
              </tr>
              <tr>
            ...
            <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
				...
				<img src="../image/button/bt_printing.gif" width="43" height="20" onclick="javascript:printUserInfo('<%=strOffiSignFlag%>')" style="cursor:hand">&nbsp;<img src="../image/button/bt_cancel.gif" width="43" height="20" style="cursor:hand" onclick="window.location='/index.html'"></td>
