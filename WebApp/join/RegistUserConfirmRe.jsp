...
function checkCertification(result)
{
	...
	{			
		...
		form.action = "/join/RegistUserConfirmReProc.jsp";
		form.submit();
	}	
            ...
            <div class="schBox" >
                ...
                <div class="box"> 
                    ...
                    <table width="600px" border="0" cellspacing="3" cellpadding="0">
                        <tr>
                            <td width="180">&bull;&nbsp;<strong>사용자 인증서 구분</strong></td>
                            <td width="411"><input onclick="selCertType('0')" value="0" checked="checked" type="radio" name="cert_type" class="borderNo" />
                                개인
                                <!--<input onclick="selCertType('1')" value="1" type="radio" name="cert_type" class="borderNo" />
                                법인--> </td>
                        </tr>
						<tr>
						...
						<td>&bull;&nbsp;<strong>사업자번호</strong></td>
							<td>								
								<input name="office_ssn" type="text" class="textfield" size="15" maxlength=10>
							</td>
						</tr>
                    </table>
                </div>
            </div>
            <div id="btn_all" class="t_right"> <span class="list_bt"><a href="javascript:aaa()">확 인</a></span> <span class="list_bt"><a href="#" onclick="window.location='/index.html'">취 소</a></span> </div>
