          ...
          <td width="601" bgcolor="ffffff"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
			  ...
			  <form method="post">
                ...
                <td height="40"><img src="../image/button/bt_agree.gif" width="57" height="20" onclick="goJoinMember(this.document.forms[0])" style="cursor:hand">&nbsp;<img src="../image/button/bt_dontagree.gif" width="69" height="20" onclick="window.location='/index.html'" style="cursor:hand"></td>
				</form>
              </tr>
              <tr valign="top"> 
                <td height="10">&nbsp;</td>
