...
<%
	...
	strCertDn = request.getParameter("CERT_DN")==null?"":request.getParameter("CERT_DN") ;
	...
	while(nIndex != -1)
	{
			...
			if(nIndex == -1){
				...
				System.out.println("===================>arg"+i+":"+strRetVal.substring(nStartIndex,strRetVal.length()));
				arg[i] = strRetVal.substring(nStartIndex,strRetVal.length());
			...
			}else
			{
				...
				System.out.println("====================>arg"+i+":"+strRetVal.substring(nStartIndex,nIndex));
				arg[i] = strRetVal.substring(nStartIndex,nIndex);
			}
...
%>
<%
	if(objHshReqUserInfo.get("ORGAN_ID")!=null &&
