    ...
    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr valign="top">
          ...
          <td width="601" bgcolor="ffffff"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<form action="/join/test/JoinMember.jsp" name="frmCheckUser" method="post">
...
<script language="javascript" src="/js/AxNAROK.js"></script>
</body>
</html>
...
function checkCertification()
{
	...
	/*if(CERT_DN == "null" || CERT_DN == "")
		alert("인증서확인을 하시기 바랍니다.");
	else
		this.document.frmCheckUser.submit();
	*/
