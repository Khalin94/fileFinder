...
*/
	...
	try{
		...
		if(in_eventdate != null && !in_eventdate.equals("")){
			...
			objHshParam.put("username",in_username);
			objHshParam.put("eventdate",in_eventdate.substring(2,8));
            ...
            <div class="schBox" >
                ...
                <div class="box">
                    ...
                    <table width="600px" border="0" cellspacing="3" cellpadding="0">  
						<tr>
                            <td>&bull;&nbsp;<strong style="font-size:12px">생년월일</strong></td>
						...
						<tr>
                            <td>&bull;&nbsp;<strong style="font-size:12px">성명</strong></td>
