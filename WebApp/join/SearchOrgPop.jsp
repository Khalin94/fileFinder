...
<tr> 
    ...
    <td height="25" valign="middle"><img src="../image/join/icon_join_soti.gif" width="9" height="9" align="absmiddle"> 
      <span class="soti_join"> 기관 찾기</span></td>
  </tr>
  <tr height="14"> 
    <td height="2"></td>
    <td height="2"></td>
          ...
          <td valign="top">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">		
			  ...
			  <tr align="center" onMouseOver="this.style.backgroundColor='#f4f4f4'" OnMouseOut="this.style.backgroundColor=''"> 
				...
				<td height="22"><a href ="javascript:selectOrgan('<%=strOrganId%>','<%=strOrganNm%>', '<%=strOrganNo%>','<%=strHomeUrl%>','<%=strJuso1%>','<%=strJuso2%>');"><%=strOrganNm%></a></td>
  ...
  <tr align="right"> 
    <td height="20" colspan="2" class="td_gray1">&nbsp;<a href="javascript:self.close()"><img src="../image/button/bt_close.gif" width="46" height="11" border="0"></a>&nbsp;&nbsp;</td>
  </tr>
</table>
</body>
</html>
