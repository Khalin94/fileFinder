...
//alert(InnoDS.GetFileCount());
	...
	function OnUploadComplete(objName){
        ...
        //alert('kangthis log => ' + oForm.OrgRealFileName.value);
        oForm.target = "processingFrame";
        InnoDSSubmit(document.inputForm);
    }
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
        ...
        <script language="javascript">
            if (navigator.appName == "Microsoft Internet Explorer") {
                ...
                str = str + " codebase='http://172.16.47.178/cab/ezPDFConv.cab#Version=1,0,0,6' ";
            ...
            if (ezPDF_PluginOK) {
                if(ezPDF_PluginVersionOK) {
                    ...
                    str = str + "<BR>";
                    str = str + "<A HREF='http://172.16.47.178/cab/ezPDFConv.exe'>Install ezPDFConv Plug-in</A>";
                    str = str + "</TD></TR>";
                    str = str + "</table>";
                }
            }
