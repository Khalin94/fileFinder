...
<%
	...
	String strDataID = nads.lib.reqsubmit.util.StringUtil.getEmptyIfNull(StringUtil.getNVLNULL(request.getParameter("dataid")));			//게시물 아이디

	String strFileID = nads.lib.reqsubmit.util.StringUtil.getEmptyIfNull(StringUtil.getNVLNULL(request.getParameter("fileid")));			//파일 아이디
