...
<table width="500" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr height="14"> 
   ...
   <tr height="14"> 
    ...
    <img src="/images/main/tabs_ji_on.gif" alt="지번주소검색" align="absmiddle" style="border : none"/></a>
    <a href="javascript:goRoadZipcd();">
    <img src="/images/main/tabs_do_off.gif" alt="도로명주소검색" align="absmiddle" style="border : none"/></a>
     -->
     <!-- 2015-04-23 수정 후 -->
     <a href="javascript:goRoadZipcd();">
    <img src="/images/main/tabs_do_off.gif" alt="도로명주소검색" align="absmiddle" style="border : none"/></a>
