...
<%
	...
	//String strUserId= HashEncrypt.decrypt(request.getParameter("USER_ID")) ;
	//String strPwd= HashEncrypt.decrypt(request.getParameter("PWD"));

	String strUserId = HashEncrypt.decrypt((String)session.getAttribute("USER_ID"));
	String strPwd = HashEncrypt.decrypt((String)session.getAttribute("PWD"));

	//String id = (String)session.getAttribute("id");
	//String pwd = (String)session.getAttribute("pwd");

	System.out.println("CLIENT_ID : "+strUserId);
	System.out.println("CLIENT_ID : "+strPwd);

	//System.out.println("id : "+id);
	//System.out.println("pwd : "+pwd);

	//session.removeAttribute("TID");
	//session.removeAttribute("TPWD");


	//사용자 아이피를 얻어 세션값에 저장.
	String strClientIP = request.getHeader("Proxy-Client-IP");

	System.out.println("CLIENT_IP :: "+strClientIP);
	...
	try
	{
		...
		System.out.println("성공 : "+isSuccess);
		//성공하면 세션정보를 셋팅
		if (isSuccess){
