...
<form name="frmLogin" action="/login/Login4ReSessionProc.jsp" method=post onsubmit="return checkValidation(this);">
  <input type='text' name='USER_ID' style="display:none"></input>
  <input type='password' name='PWD' style="display:none"></input>
  <tr>
  ...
  <img src="http://naps.assembly.go.kr/image/login/login_01_top.gif" border="0" onclick="document.frmLogin.submit()" style="display:none">
</form>
</table>
</body>
</html>
