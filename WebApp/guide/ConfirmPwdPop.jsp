...
<script language="javascript">
	...
	function cfmPwd(){
                ...
                if (frm.tmp_cfmpwd.value == "" || frm.tmp_cfmpwd.value == null){
                        alert("비밀번호를 입력해 주세요.");
                        frm.tmp_cfmpwd.focus();
                        return false;
                }

                var temp = CryptoJS.SHA256(frm.tmp_cfmpwd.value).toString();
                frm.cfmpwd.value = temp.toUpperCase();
                frm.tmp_cfmpwd.value = "";
		}
...
<form name="frmPwd" method="post" action="/guide/AuthPwdProc.jsp"  onSubmit="return cfmPwd();">
...
<input type="hidden" name="cfmpwd" >
  ...
  <tr> 
    ...
    <td height="23" align="left" valign="top"><table width="95%" border="0" cellspacing="4" cellpadding="0">
        ...
        <tr> 
          <td align="center"><input name="tmp_cfmpwd" type="password" class="textfield" style="WIDTH: 100px"></td>
        </tr>
      </table></td>
  </tr>
  <tr> 
