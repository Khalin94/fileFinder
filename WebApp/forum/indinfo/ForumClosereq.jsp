...
function fnChk() {
	if(document.form.closeRsn.value=="") {
		alert("폐쇄신청사유를 입력해주세요");
		document.form.closeRsn.focus();
		return false;
	}

	if (fnSpaceChk(document.form.closeRsn.value, "폐쇄신청사유를 올바르게 입력하세요.") == false ) 	return false;

	if(document.form.closeRsn.value.length > 250) {
		alert("폐쇄 사유를 250자 이내로 입력해주세요");
		document.form.closeRsn.focus();
		return false;
	}
...
<table width="380" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    <td width="14">&nbsp;</td>
    <td height="25" valign="middle"><img src="/image/forum/icon_forumpop_soti.gif" width="9" height="9">&nbsp;<span class="soti_forumpop">포럼 폐쇄신청 </span></td>
  </tr>
  <tr>
    <td height="5"></td>
    <td height="5"><table width="96%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td height="25" valign="bottom" class="text_s">선택하신 <strong>&quot;<%=strForumNM%>&quot;</strong>의 포럼 폐쇄 사유를 입력해 주세요.</td>
        </tr>
      </table></td>
  </tr>
  <tr> 
