...
<%
	...
	String strDelGoToPage = URLEncoder.encode("/forum/board/ForumBoardList.jsp", "UTF-8");
	...
	try{
		...
		objAryTtopList = objForumBoard.selectTtopDataList((String)objHshMainInfo.get("TTOP_BBRD_ID"));
...
<script language="javascript">
	...
	function goToUpdate(frm){
		...
		frm.action = "UpdateForumBoard.jsp?strCurrentPage=<%=strCurrentPage%>&bbrdid=<%=strBbrdID%>&dataid=<%=strDataID%>";
	...
	function goToAnswer(frm){
		...
		//상위 게시물에 대한 정보를 보낸다.
		//delete 때문에 encType="multipart/form-data"를 사용하므로 get 방식으로 데이타를 넘김 
		frm.action = "WriteForumBoard.jsp?strCurrentPage=<%=strCurrentPage%>&bbrdid=<%=strBbrdID%>&dataid=<%=strDataID%>&ttopid=<%=strTtopID%>&toplevel=<%=strLevel%>&toporder=<%=strOrder%>";
	...
	function goToOneSave(){
        ...
        //alert("<%=strOneExt%>");
        //frm.nowext.value = "<%=strOneExt%>";
        //frm.action = "/board/common/BoardOneAnsProc.jsp?cmd=ONE_CREATE";
        //frm.submit();
	}
</script>
</head>
          ...
          <td align="left"><table width="759" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
				...
				<input type="hidden" name="fileext" value="">
                    ...
                    <tr> 
                      <td width="120" height="25" class="td_gray1"><img src="/image/common/icon_nemo_gray.gif" width="3" height="6"> 제목</td>
                      <td width="560" height="25" class="td_lmagin"><%=strTitle%></td>
                    </tr>
                    <tr class="tbl-line"> 
                    ...
                    <tr> 
                      <td width="130" height="25" class="td_gray1"><img src="/image/common/icon_nemo_gray.gif" width="3" height="6"> 등록자</td>
                      <td width="560" height="25" class="td_lmagin"><%=strUserNm%> (조회 : <%=strQryCnt%>)</td>
                    </tr>
                    <tr class="tbl-line"> 
                      <td width="120" height="1"></td>
                      <td width="560" height="1"></td>
                    ...
                    <tr> 
                      <td width="120" height="25" class="td_gray1"><img src="/image/common/icon_nemo_gray.gif" width="3" height="6"> 등록일</td>
                      <td width="560" height="25" class="td_lmagin"><%=strWriteTs%></td>
                    </tr>
                    <tr class="tbl-line"> 
                      <td width="120" height="1"></td>
                      <td width="560" height="1"></td>
                    ...
                    <tr> 
                      <td width="120" height="45" class="td_gray1"><img src="/image/common/icon_nemo_gray.gif" width="3" height="6"> 내용</td>
                      <td width="560" height="45" valign="top" class="td_box"><%=strCont%></td>
                    </tr>
                    <tr class="tbl-line"> 
                      <td width="120" height="1"></td>
                      <td width="560" height="1"></td>
                    ...
                    <tr> 
                      <td width="120" height="25" class="td_gray1"><img src="/image/common/icon_nemo_gray.gif" width="3" height="6"> 파일</td>
	                  ...
	                  <a href="/forum/common/FileDownload.jsp?dataid=<%=strDataID%>&fileid=<%=(String)objHshFile.get("FILE_ID")%>"><%=(String)objHshFile.get("FILE_NAME")%></a> 
                    ...
                    <tr>
                      <td colspan="2" align="left" valign="top">
	                     ...
	                     <table width="680" border="0" cellspacing="0" cellpadding="0">
	                      ...
	                      <tr class="td_top"> 
	                        <td width="454" height="22" align="center">제목</td>
                     ...
                     <tr> 
                      <td height="40" align="left" colspan="2">
                      	<% 
                      		...
                      		if(strDelFlag.equals("N") && strBbrdKind.equals(allFreeBoard)){
              ...
              <tr>
              	...
              	<!-- 한줄답글 리스트 시작 ---------------------------->
	            <% if(strDelFlag.equals("N") && strBbrdOneExt.equals("Y")){ %>
              	<table width="680" border="0" cellspacing="0" cellpadding="0">
				...
				<!--input type="hidden" name="oneid" value="">
				<input type="hidden" name="onecnt" value=""-->
	              <%	
					if(strOneExt.equals("Y")){
						...
						try {
							...
							objAryOneAnsList = objForumBoard.selectOneAnsList(strDataID);
