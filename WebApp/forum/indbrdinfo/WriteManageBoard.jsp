    ...
    <td align="center"><table width="589" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td align="left" valign="top">
		    ...
		    <form name="frmWrite" method="post" action="ManageBoardProc.jsp" onSubmit="return isSave();">
			...
			<input type="hidden" name="oneext" value="">
              <tr> 
                <td width="100" height="2" class="td_forumpop"></td>
                <td width="470" height="2" class="td_forumpop"></td>
              </tr>
              <tr> 
                <td height="25" class="td_gray1"><img src="/image/common/icon_nemo_gray.gif" width="3" height="6"> 게시판 이름</td>
                <td height="25" class="td_lmagin"><input name="bbrdnm" type="text" class="textfield" style="WIDTH: 300px"></td>
              </tr>
              <tr> 
			  ...
			  <tr> 
                ...
                <td height="25" class="td_lmagin">
                  <select name="bbrdkind" class="select">
                  	...
                  	<option value="<%=freeBoard%>">게시판</option>
              ...
              <tr> 
                <td height="25" class="td_gray1"><img src="/image/common/icon_nemo_gray.gif" width="3" height="6"> 파일첨부</td>
                <td height="25" class="td_lmagin">
                  <select name="filecnt" class="select">
                  <% for (int i = 0; i < intFileMaxCnt + 1; i++) {%>
              ...
              <tr> 
                ...
                <td height="25" class="td_lmagin">
                  <input type="radio" name="selans" value="Y"> 사용함 
                  <input type="radio" name="selans" value="N"> 사용안함
                </td>
              </tr>
              <tr> 
                <td height="1" class="tbl-line"></td>
              ...
              <tr> 
                <td height="25" class="td_gray1"><img src="/image/common/icon_nemo_gray.gif" width="3" height="6"> 한줄답글</td>
                <td height="25" class="td_lmagin">
      			  <input type="radio" name="selone" value="Y"> 사용함 
                  <input type="radio" name="selone" value="N"> 사용안함
      			</td>
              </tr>
              <tr> 
                <td height="1" class="tbl-line"></td>
              ...
              <tr> 
                ...
                <td height="45" valign="top" class="td_box"><textarea name="dsc" wrap="hard" class="textfield" style="WIDTH: 100% ; height: 100"></textarea></td>
              </tr>
              <tr height="1"> 
