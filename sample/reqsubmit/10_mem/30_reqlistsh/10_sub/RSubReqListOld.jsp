	                    	...
	                    	<td>
	                    		<table width="759" border="0" cellspacing="0" cellpadding="0">
									<tr class="td_top">
										...
										<td height="27" width="34" align="center">NO</td>
										<td width="410" align="center"><%=SortingUtil.getSortLink("changeSortQuery","REQ_CONT",strReqInfoSortField,strReqInfoSortMtd,"요구제목")%></td>
										<td width="60" align="center"><%=SortingUtil.getSortLink("changeSortQuery","REQ_BOX_NM",strReqInfoSortField,strReqInfoSortMtd,"요구함")%></td>
										<%
											int intTmpWidth1=90;
											if(objUserInfo.getOrganGBNCode().equals("003")){//의원실소속
										%>
										<td width="60" align="center"><%=SortingUtil.getSortLink("changeSortQuery","CMT_REQ_APP_FLAG",strReqInfoSortField,strReqInfoSortMtd,"위원회")%></td>
										<%
											 intTmpWidth1=intTmpWidth1-50;
											}//endif의원실소속확인
										%>										
										<td width="<%=intTmpWidth1%>" align="center">답변</td>
										<td width="70" align="center"><%=SortingUtil.getSortLink("changeSortQuery","REG_DT",strReqInfoSortField,strReqInfoSortMtd,"등록일시")%></td>
										<td width="70" align="center"><%=SortingUtil.getSortLink("changeSortQuery","LAST_ANS_DT",strReqInfoSortField,strReqInfoSortMtd,"답변일시")%></td>
									</tr>
	                    		</table>
	                    	</td>
	                    </tr>
							...
							<td>
								<table width="759" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td height="27" width="34" align="center"><%=intRecordNumber%></td>
										<td width="410" class="td_lmagin">&nbsp;&nbsp;<a href="JavaScript:gotoDetail('<%=strReqInfoID%>');" hint="<%= StringUtil.substring((String)objRs.getObject("REQ_DTL_CONT"), 100) %> ..."><%=(String)objRs.getObject("REQ_CONT")%></a></td>
										<td width="60" align="center"><a href="<%=nads.dsdm.app.reqsubmit.delegate.requestinfo.RequestInfoDelegate.getGotoMemReqBoxURLReqr((String)objRs.getObject("REQ_BOX_STT"))%>?ReqBoxID=<%=objRs.getObject("REQ_BOX_ID")%>"><img src="/image/reqsubmit/icon_secretariat.gif" border="0" alt="<%=objRs.getObject("REQ_BOX_NM")%> 바로가기"></a></td>
										<%
											int intTmpWidth2=90;
											if(objUserInfo.getOrganGBNCode().equals("003")){//의원실소속
										%>
										...
										%>
										<td width="<%=intTmpWidth2%>" align="center"><%=nads.lib.reqsubmit.util.DBAccessUtil.makeAnsInfoHtml((String)objRs.getObject("ANS_ID"),(String)objRs.getObject("ANS_MTD"),(String)objRs.getObject("ANS_OPIN"),(String)objRs.getObject("SUBMT_FLAG"),objUserInfo.isRequester())%></td>
										<td width="70" align="right" style="padding-top:2px;pading-bottom:2px;padding-right:2px"><%=StringUtil.getDate2((String)objRs.getObject("REG_DT"))%> </td>
										<td width="70" align="right" style="padding-top:2px;pading-bottom:2px;padding-right:2px"><%=StringUtil.getDate2((String)objRs.getObject("LAST_ANS_DT"))%> </td>
                    	...
                    	<tr> 
                      		<td width="256" height="40">
								...
								<%
                      			...
                      			%>
										<!-- 바인더 담기 -->
                      					<img src="/image/button/bt_putBinder.gif" height="20"  style="cursor:hand" onClick="addBinder(document.formName);" alt="선택된 문서를 바인더 요구목록에 등록하여 바인딩할 수 있도록 합니다.">
                      			<%
                      				}
                      			%>
                      		</td>
