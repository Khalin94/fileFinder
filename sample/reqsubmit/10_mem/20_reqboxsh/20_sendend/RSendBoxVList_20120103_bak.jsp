...
-->
		...
		%>
			 <span class="list_bt"><a href="<%= strJscript %>">요구함 삭제</a></span>
			 ...
			 <span class="list_bt"><a href="javascript:ReqDocOpenView('<%= (String)objParams.getParamValue("ReqBoxID") %>')">요구서 보기</a></span>
		 </div>
	...
	%>
       ...
       <!-- 리스트 버튼-->
		...
		<% if(objRs.getRecordSize()>0 && (!objCmtSubmt.checkCmtOrganMakeAutoSche((String)objRsSH.getObject("CMT_ORGAN_ID")) || !objUserInfo.getIsMyCmtOrganID((String)objRsSH.getObject("CMT_ORGAN_ID")))) { %>
			<span class="list_bt"><a href="javascript:ApplyCmt(document.formName);">위원회 제출 신청</a></span>
		<% } %>
<!--
