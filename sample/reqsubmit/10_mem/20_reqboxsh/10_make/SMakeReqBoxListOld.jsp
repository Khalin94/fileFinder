...
<%
	...
	System.out.println("BASIC_ORGAN_ID1 : "+objUserInfo.getBasicOrganID());
	System.out.println("BASIC_ORGAN_ID2 : "+objUserInfo.getOrganID());
	...
	try {
		...
		Hashtable objaaa = (Hashtable)selfDelegate.getRecordList(paramForm);
          ...
          <table width="759" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td height="30" align="left" class="text_s">
                		<!-------------------- 현재 페이지에 대한 설명 기술 ------------------------>
                		국회(의원실, 사무처, 예산정책처, 전문위원 등)로부터 발송된 요구함 목록을 확인하실 수 있습니다.
                </td>
              </tr>
...
%>
					...
					<table width="759" border="0" cellspacing="0" cellpadding="0">
    	                ...
    	                <tr align="center" class="td_top"> 
	                	    ...
	                	    <td width="340" height="22"><%=SortingUtil.getSortLink("changeSortQuery", "REQ_BOX_NM", strReqBoxSortField, strReqBoxSortMtd, "요구함명")%></td>
                    	  	<td width="150" height="22"><%=SortingUtil.getSortLink("changeSortQuery", "REQ_ORGAN_NM", strReqBoxSortField, strReqBoxSortMtd, "요구기관")%></td>
	                      	<td width="80" height="22"><%=SortingUtil.getSortLink("changeSortQuery", "RLTD_DUTY", strReqBoxSortField, strReqBoxSortMtd, "업무구분")%></td>
    	                  	<td width="70" height="22"><%=SortingUtil.getSortLink("changeSortQuery", "LAST_REQ_DOC_SND_DT", strReqBoxSortField, strReqBoxSortMtd, "수신일시")%></td>
        	              	<td width="80" height="22">답변/요구</td>
            	        </tr>
                	    <tr> 
	                    ...
	                    <tr onMouseOver="this.style.backgroundColor='#FCFDF0'" onMouseOut="this.style.backgroundColor=''"> 
            	          	...
            	          	<td width="340" class="td_lmagin" style="padding-left:5px"><a href="javascript:gotoDetail('<%=strReqBoxID%>')"><%= (String)rsHelper.getObject("REQ_BOX_NM") %></a></td>
                      		...
                      		<td width="70" align="right" style="padding-top:2px;padding-bottom:2px"><%= StringUtil.getDate2((String)rsHelper.getObject("LAST_REQ_DOC_SND_DT")) %></td>
