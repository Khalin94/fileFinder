...
<% } %>
		...
		<p>
		<% if ("N".equalsIgnoreCase(strAnsStt)) { %>
		&nbsp;&nbsp;
		...
		&nbsp;&nbsp;
		<img src="/image/button/bt_cancel.gif" border="0" onClick="javascript:window.close();" style="cursor:hand">
		<% } else { %>
