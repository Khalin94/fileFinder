...
<%@ include file="/reqsubmit/common/SUserCodeInfoInc.jsp" %>
              ...
              <tr> 
                ...
                <!------------------------- TAB에 해당하는 테이블(목록이든 등록폼이든 상세정보든) 출력 시~~~작 ------------------------->
					<table width="680" border="0" cellspacing="0" cellpadding="0">
                    	...
                    	<tr> 
                      		<td height="25" class="td_gray1">
                      			<img src="/image/common/icon_nemo_gray.gif" width="3" height="6"> 상세 내용
                      		</td>
...
<form name="inputForm" method="post" action="" enctype="multipart/form-data" style="margin:0px">
				...
				<input type="hidden" name="ansrID" value="<%= strUserID %>">
