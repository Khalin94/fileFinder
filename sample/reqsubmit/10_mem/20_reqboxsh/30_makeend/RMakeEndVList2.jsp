      ...
      <div id="contents">
        ...
        <!-- 상단 버튼-->
         ...
         <div class="top_btn">
			...
			<span class="btn"><a href="#" onClick="submtBindingJob(formName,'<%=(String)objParams.getParamValue("ReqBoxID")%>')">바인딩</a></span>
		...
		<% } %>
			 ...
			 <td colspan="3">
			  ...
			  <li><span class="tl">&bull;&nbsp;답변서발송일시:</span> <%=StringUtil.getDate2((String)objRsSH.getObject("LAST_ANS_DOC_SND_DT"))%></li>
              </ul>
              </td>
            </tr>
        ...
        <div id="btn_all"><div  class="t_right">
			<div class="mi_btn"><a href="#" onClick="ReqDocOpenView('<%= (String)objParams.getParamValue("ReqBoxID") %>')"><span>요구서 보기</span></a></div>
			<div class="mi_btn"><a href="#" onClick="AnsDocOpenView('<%= (String)objParams.getParamValue("ReqBoxID") %>')"><span>답변서 보기</span></a></div>
        </div></div>
        <!-- list -->
