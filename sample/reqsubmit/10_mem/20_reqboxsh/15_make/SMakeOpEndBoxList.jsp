...
<%
	...
	System.out.println("SORT :: "+(String)paramForm.getParamValue("ReqBoxSortField"));
	...
	try {
		...
		System.out.println("TEST :: "+(String)paramForm.getParamValue("ReqBoxStt"));
...
<script language="javascript">
	...
	function changeSortQuery(sortField, sortMethod){
  	...
  	function gotoDetail(strID){
  		...
  		form.action="SMakeOpEndBoxVList.jsp";
  		form.submit();
  	}
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="list01">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><%= (String)rsHelper.getObject("REQ_ORGAN_NM") %>
			  </td>
              ...
              <td><%= StringUtil.getDate2((String)rsHelper.getObject("LAST_ANS_DOC_SND_DT")) %></td>
				...
				%>
			<tr>
				<td colspan="5" align="center">등록된 요구자료가 없습니다.</td>
			</tr>
				<%
					} // end if
				%>
