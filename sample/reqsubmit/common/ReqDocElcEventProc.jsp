...
<%
	...
	// 2004-06-15 전자결재에서 넘겨주는 추가된 문서번호
	String strDocNo = StringUtil.getEmptyIfNull(request.getParameter("docno"));
	...
	if (CodeConstants.ELC_EVENT_0X01.equalsIgnoreCase(strEventCode)) {		 			// ELC_EVENT_0X01 : 상신
		...
		intResult = objRDSDelegate.setRecordToReqBoxStt(strReqBoxID, strEventCode, strDocNo);
