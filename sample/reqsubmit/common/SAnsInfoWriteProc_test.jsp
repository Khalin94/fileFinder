...
<%
	...
	try {
		...
		String AuditYear	  = request.getParameter("AuditYear")==null?"":request.getParameter("AuditYear");
                /*String strOrgRealFileName = request.getParameter("OrgRealFileName");
		String strPdfRealFileName = request.getParameter("PdfRealFileName");
		
		System.out.println("kangthis logs strOrgRealFileName :"+strOrgRealFileName);
		System.out.println("kangthis logs strPdfRealFileName :"+strPdfRealFileName);*/
		...
		if (CodeConstants.ANS_MTD_ELEC.equalsIgnoreCase(strAnsType)) { // 전자문서이다.
			...
			String MsgDigest[] = StringUtil.split("Ω",objParamForm.getParamValue("MsgDigest"));
                        ...
                        String OrgRealFileName[] = StringUtil.split("Ω",request.getParameter("OrgRealFileName"));
			String PdfRealFileName[] = StringUtil.split("Ω",request.getParameter("PdfRealFileName"));
			for(int i = 0;i<count; i++){
                ...
                System.out.println("kangthis log OriginFileName[i]" +i+"번째 => "+OrgRealFileName[i]);
                System.out.println("kangthis log PdfRealFileName[i]"+i+"번째 => "+PdfRealFileName[i]);
...
objParamForm.setParamValue("OrgRealFileName",OrgRealFileName[i]);
				...
				System.out.println("kangthis logs OrgRealFileName 최종 => " + objParamForm.getParamValue("OrgRealFileName"));
				System.out.println("kangthis logs PdfRealFileName 최종 => " + objParamForm.getParamValue("PdfRealFileName"));
