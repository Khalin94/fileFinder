	...
	<tr>
		<td width="190" align="center">
			<table border="0" cellspacing="0" cellpadding="0" border="1px solid #c0c0c0;">
				...
				<tr>
					<td height="23" class="f4">&nbsp;&nbsp;□ <a href="/reqsubmit/10_mem/10_reqboxmk/RNewBoxMake.jsp">요구함 작성</a></td>
				</tr>
				<tr>
					<td height="23" class="f4">&nbsp;&nbsp;□ 요구함 조회</td>
				</tr>
				<tr>
					<td height="23" class="normal">&nbsp;&nbsp;&nbsp;&nbsp;- <a href="/reqsubmit/10_mem/20_reqboxsh/10_make/RMakeReqBoxList.jsp">작성 중 요구함</a></td>
				</tr>
				<tr>
				...
				<tr>
					<td height="23" class="normal">&nbsp;&nbsp;&nbsp;&nbsp;- <a href="/reqsubmit/10_mem/30_reqlistsh/10_sub/RSubReqList.jsp">제출 완료 요구 목록</a></td>
				</tr>
				<tr>
					<td height="23" class="normal">&nbsp;&nbsp;&nbsp;&nbsp;- <a href="/reqsubmit/10_mem/30_reqlistsh/10_sub/RNonReqList.jsp">미제출 요구 목록</a></td>
				</tr>
				<% } else { %>
				<tr>
