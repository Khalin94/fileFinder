...
<form name="form1" method="post" action="<%=request.getRequestURI()%>">
      ...
      <div id="pgTit" style="background:url(/images2/foundation/stl_bg02.gif) no-repeat left top;">
        <h3>관련기관 관리</h3>
        <div class="navi"><img src="/images2/foundation/home.gif" width="13" height="11" /> <%=MenuConstants.GOTO_HOME%> > <%=MenuConstants.REQ_SUBMIT_MAIN_MENU%> > <%=MenuConstants.REQUEST_BOX_COMM%> > 관련기관 관리</div>
        <p><!--문구--></p>
      </div>
      <!-- /pgTit -->
      ...
      <div id="contents">
        ...
        <div class="schBox">
         <!-- <p>요구함조회조건</p>  -->
          <span class="line"><img src="/images2/foundation/search_line.gif" width="172" height="3" /></span>
			  <div class="box">
			  위원회 관련 기관 추가 삭제 및 관련 기관 대표 담당자 설정을 하실 수 있습니다.
        ...
        <table width="95%" height="420" border="0" cellpadding="0" cellspacing="0">
			<tr> 
				<td width="49%" align="left" valign="top">
					<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="CCCCCC">
						<tr> 
							<td valign="top" bgcolor="ffffff">
								...
								<!-- 요구기관 트리 Start-->
								<iframe name="list1" src="SubmissionOrgan.jsp?strRelCd=001&strOrganID=<%=objUserInfo.getOrganID()%>" frameborder=0 width='100%' height='420' leftmargin='0' rightmargin='0' topmargin='0' scrolling=yes></iframe>
								<!-- 요구기관 트리 End -->
					...
					<br>
					<span class="right"><span class="list_bt"><a href="javascript:setOrders()">저장</a></span><span class="list_bt"><a href="javascript:setRelOrgan()">신규등록</a></span><span class="list_bt"><a href="javascript:setOrganRelation('D','<%=objUserInfo.getOrganID()%>')">선택삭제</a></span></span>
				</td>
				<td width="2%">&nbsp;</td>
				<td width="49%" valign="top">
					<table width="100%" height="100%" border="0"  cellspacing="1" cellpadding="0" bgcolor="CCCCCC">
						<tr> 
							<td valign="top" bgcolor="ffffff">
								<!-- 제출기관 목록 Start -->    					
								<iframe name="list2" src="about:blank" frameborder=0 width='100%' height='420' leftmargin='0' rightmargin='0' topmargin='0' scrolling=yes></iframe>
								<!-- 제출기관 목록 End -->
							</td>
						</tr>                    					
					</table>
