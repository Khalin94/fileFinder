	...
	<tr valign="top"> 
		...
		<tr> 
            ...
            <tr align="center" class="td_top"> 
        	  	...
        	  	<td width="350"><%=SortingUtil.getSortLink("changeSortQuery","REQ_BOX_NM",strReqBoxSortField,strReqBoxSortMtd,"요구함명")%></td>
               	<td width="150" style="padding-top:2px;padding-bottom:2px"><%=SortingUtil.getSortLink("changeSortQuery","REQ_ORGAN_NM", strReqBoxSortField, strReqBoxSortMtd, "소관위원회")%><BR><%=SortingUtil.getSortLink("changeSortQuery","OLD_REQ_ORGAN_NM", strReqBoxSortField, strReqBoxSortMtd, "(의원실)")%></td>
             	<td width="80">제출/요구</td>
             	<td width="70"><%=SortingUtil.getSortLink("changeSortQuery","LAST_REQ_DOC_SND_DT", strReqBoxSortField, strReqBoxSortMtd, "요구일시")%></td>
               	<td width="70"><%=SortingUtil.getSortLink("changeSortQuery","LAST_ANS_DOC_SND_DT", strReqBoxSortField, strReqBoxSortMtd, "답변일시")%></td>
	        </tr>
    	    <tr> 
