...
<form name="formName" method="post" action="<%=request.getRequestURI()%>">
      ...
      <div id="pgTit" style="background:url(/images2/foundation/stl_bg02.gif) no-repeat left top;">
        ...
        <p>제출기관에게 발송한 요구함 정보를 확인하는 화면입니다. </p>
      </div>
      <!-- /pgTit -->
      ...
      <div id="contents">
             ...
             <tr>
			  ...
			  <td colspan="3">
				 <table width="100%" border="0" cellspacing="0" cellpadding="0" class="list_none">
					 ...
					 <tr>
						 <td class="fonts"><%=(String)objRsSH.getObject("REGR_NM")%> (<a href="mailto:<%=(String)objRsSH.getObject("REGR_EMAIL")%>"><%=(String)objRsSH.getObject("REGR_EMAIL")%></a> / <%=(String)objRsSH.getObject("REGR_CPHONE")%>)<%=(String)objRsSH.getObject("RCVR_NM")%></td>
						 <td class="fonts"></td>
					 </tr>
				 </table>
			</td>
		...
		<%if(objUserInfo.getOrganGBNCode().equals("004") && !strReqSubmitFlag.equals("004") && existFlag.equals("N")) {%>
			 <span class="list_bt"><a href="javascript:deleteReqBox(<%=objRsSH.getObject("REQ_BOX_ID")%>)">요구함 삭제</a></span>
		<%}%>
