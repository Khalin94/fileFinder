...
<%
	...
	objParams.setParamValue("SmtOrganID",objUserInfo.getOrganID());							/** 제출기관ID*/
	objParams.setParamValue("CommReqInfoSortField","LAST_REQ_DT");							/** 요구일자가 Default*/
...
<%
	...
	try {
		...
		objRs = new ResultSetHelper(objReqInfo.getReqList(objParams));
	                    	...
	                    	<td>
	                    		<table width="759" border="0" cellspacing="0" cellpadding="0">
									<tr class="td_top">
										...
										<td width="330" align="center"><%=SortingUtil.getSortLink("changeSortQuery","REQ_CONT",strCommReqInfoSortField,strCommReqInfoSortMtd,"요구제목")%></td>
										<td width="150" align="center"><%=SortingUtil.getSortLink("changeSortQuery","REQ_ORGAN_NM",strCommReqInfoSortField,strCommReqInfoSortMtd,"요구기관")%></td>
							...
							<td>
								<table width="759" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td width="330" class="td_lmagin"><%= StringUtil.getNotifyImg((String)objRs.getObject("REG_DT"), (String)objRs.getObject("REQ_STT")) %><a href="JavaScript:gotoDetail('<%=strReqBoxID%>','<%=strCommReqID%>');" hint="<%=StringUtil.substring((String)objRs.getObject("REQ_DTL_CONT"), 80)%>"><%=StringUtil.substring((String)objRs.getObject("REQ_CONT"),30)%></a></td>
										<td width="150" class="td_lmagin"><%=objRs.getObject("REQ_ORGAN_NM")%></td>																				
										...
										<td width="70" align="right" style="padding-top:2px;padding-bottom:2px"><%=StringUtil.getDate2((String)objRs.getObject("LAST_REQ_DT"))%> </td>
									</tr>
								</table>
							</td>
						</tr>
