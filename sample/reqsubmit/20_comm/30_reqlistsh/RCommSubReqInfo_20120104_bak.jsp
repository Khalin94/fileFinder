      ...
      <div id="contents">
		...
		%>
            ...
            <tr>
                ...
                <td height="25" width="220"><%=objRsSH.getObject("CMT_ORGAN_NM")%> (<%=(String)objRsRI.getObject("REGR_NM")%>) </td>
		...
		%>
			 <span class="list_bt"><a href="javascript:requestAddAnswer()">추가답변 요구</a></span>
		<%	 }%>
