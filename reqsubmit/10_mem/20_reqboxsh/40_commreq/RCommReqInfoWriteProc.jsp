...
<%
 ...
 /*************************************************************************************************/
  ...
  objWriteParams.setParamValue("ReqrNm",objUserInfo.getUserName());//요구자명을 세션에서 넣어줌.
  objWriteParams.setParamValue("RegrID",objUserInfo.getUserID());//요구자ID를 세션에서 넣어줌.
  blnParamCheck=false;
  /** 요구함정보 수정 파리미터 체크 */
  /** 위에서 선언한 Wrapper */
...
<%
 ...
 try{
   /********* 대리자 정보 설정 *********/
   CmtSubmtReqInfoDelegate objReqInfo=new CmtSubmtReqInfoDelegate();   /** 요구함 정보 입력용 */
...
<script language="JavaScript">
	function init(){
		if(confirm("요구 정보가 등록되었습니다. 계속해서 요구를 등록하시겠습니까?")) {
