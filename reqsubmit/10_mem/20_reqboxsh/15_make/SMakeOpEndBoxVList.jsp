...
<script language="javascript">
	...
	function goReqBoxList() {
		f = document.viewForm;
		f.target = "";
//		f.action = "SMakeOpEndBoxList.jsp";
	...
	function changeSortQuery(sortField, sortMethod){
  	...
  	function gotoDetail(strID){
  		...
  		f.ReqID.value = strID;
		f.target = "";
 		f.action="SMakeOpEndReqInfoVList.jsp";
  		f.submit();
  	}
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="list02">
            ...
            <tr>
             ...
             <tr>
              ...
              <li><span class="tl">&bull;&nbsp;최종제출일자 :</span> <strong><%= StringUtil.getDate2(String.valueOf(objRsSH.getObject("LAST_ANS_DOC_SND_DT"))) %></strong></li>
              </ul>
              </td>
            </tr>
                <tr>
...
-->
        <div id="btn_all"><div  class="t_right">
			<div class="mi_btn"><a href="javascript:PreReqDocView(viewForm,'<%=strReqBoxID%>', '<%= CodeConstants.PRE_REQ_DOC_FORM_101 %>');"><span>요구서 보기</span></a></div>
			<div class="mi_btn"><a href="javascript:viewAnsDoc();"><span>답변서 보기</span></a></div>
		</div></div>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="list01">
          <thead>
            <tr>
              ...
              <th scope="col" style="width:40%; "><%= SortingUtil.getSortLink("changeSortQuery", "REQ_STT", strReqInfoSortField, strReqInfoSortMtd, "상태") %></th>
		...
		%>
            <tr>
              ...
              <td style="text-align:left;"><a href="javascript:gotoDetail('<%= strReqInfoID %>')" hint="<%= StringUtil.substring((String)objRs.getObject("REQ_DTL_CONT"), 80) %> ..."><%= objRs.getObject("REQ_CONT") %></a></td>
       ...
       <!-- 리스트 버튼-->
        ...
        <!-- /리스트 내 검색 -->
			<span class="right">
			<span class="list_bt"><a href="#" onclick="javascript:viewReqHistory()">요구이력보기</a></span>
<!--
