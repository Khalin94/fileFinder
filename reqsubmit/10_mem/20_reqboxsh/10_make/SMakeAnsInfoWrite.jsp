          ...
          <td align="left"><table width="759" border="0" cellspacing="0" cellpadding="0">
                ...
                <td height="23" align="left" valign="top"><table width="100%" height="23" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="25%" background="/image/reqsubmit/bg_reqsubmit_tit.gif">
                      		<!-------------------- 타이틀을 입력해 주세요 ------------------------>
							<% 
								if ("Y".equalsIgnoreCase(strAddAnsFlag)) out.println("<span class='title'>추가 답변 작성</span>");
								else out.println("<span class='title'>"+MenuConstants.REQ_BOX_MAKE+"</span> <strong>- 답변 작성</strong>");
							%>
                      </td>
              ...
              <tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td height="40" align="left">&nbsp;<img src="/image/button/bt_prevPage.gif" border="0" onClick="javascript:gotoReqInfoView()" style="cursor:hand" alt="이전 화면으로 이동합니다.">
