...
-->
		...
		%>
			 <span class="list_bt"><a href="javascript:gotoEditPage()">요구 수정</a></span> 
			 <span class="list_bt"><a href="javascript:gotoDeletePage()">요구 삭제</a></span>
			 <span class="list_bt"><a href="javascript:moveSingleMemReqInfo(document.formName,'/reqsubmit/10_mem/20_reqboxsh/10_make/RMakeReqBoxVList.jsp')">요구 이동</a></span>
		<%
				}//endif
			}//end if
		%>
			 <span class="list_bt"><a href="javascript:copySingleMemReqInfo(document.formName)">요구 복사</a></span>
		<%
