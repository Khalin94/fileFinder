...
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  onload="<%= strAddScript %>">
...
<form name="formName" method="<%=nads.lib.reqsubmit.EnvConstants.FORM_METHOD%>" action="<%=request.getRequestURI()%>">
	 ...
	 <!-- 2011-08-18 추가 pgTit -->
      <div id="pgTit" style="background:url(/images2/foundation/stl_bg02.gif) no-repeat left top;">
        ...
        <div class="navi"><img src="/images2/foundation/home.gif" width="13" height="11" /> > <%=MenuConstants.GOTO_HOME%> > <%=MenuConstants.REQ_SUBMIT_MAIN_MENU%> > <%=MenuConstants.getReqBoxGeneral(request)%> > <B><%=MenuConstants.REQ_BOX_MAKE%></div>
        <p><!--문구--></p>
      </div>
      <!-- /pgTit -->
              ...
              <tr>
				...
				<!-- 2011-08-18 추가  검색조건 없는 경우 아래 div 삭제 나 주석으로 막으세요.-->
					<div class="schBox">
					  <p>요구함조회조건</p>
              ...
              <tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="list01">
				  <thead>
					<tr>
					  <th scope="col" style="width:15px;"><input name="" type="checkbox" value="" class="borderNo" /></th>
					  ...
					  <th scope="col"><%=SortingUtil.getSortLink("changeSortQuery","REQ_BOX_STT",strReqBoxSortField,strReqBoxSortMtd,"진행상태")%></th>
					   <th scope="col">개수</th>
					  <th scope="col"><a href="#"><%=SortingUtil.getSortLink("changeSortQuery","REG_DT",strReqBoxSortField,strReqBoxSortMtd,"등록일시")%><img src="/images2/btn/bt_td.gif" width="11" height="11" alt="" /></a></th>
					</tr>
					<%
				  ...
				  <tbody>
					<tr>
					  ...
					  <td style="text-align:left;"><a href="http://110.45.144.180/foundation/SMakeReqBoxView.jsp#"><a href="javascript:gotoDetail('<%=strReqBoxID%>')"><%=(String)objRs.getObject("REQ_BOX_NM")%></a></td>
              ...
              <tr>
				...
				<!-- 페이징-->
				<span class="paging" > <span class="list_num_on"><a href="#">
                	...
                	<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    	<tr>
							...
							%>
                      		...
                      		<td width="520" align="right" height="40">
								...
								%>
										...
										<!-- img src="/image/button/bt_sendReq2_bak.gif" border="0" onClick="javascript:sendReqDoc()" style="cursor:hand" -->
										<%}else{%>
