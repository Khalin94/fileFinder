	                    	...
	                    	<td>
	                    		<table width="759" border="0" cellspacing="0" cellpadding="0">
									<tr class="td_top">
										...
										<td width="310" align="center"><%=SortingUtil.getSortLink("changeSortQuery","REQ_CONT",strReqInfoSortField,strReqInfoSortMtd,"요구제목")%></td>
										...
										<td width="50" align="center">첨부</td>
							...
							<td>
								<table width="759" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td width="60" align="center" class="td_lmagin"><a href="javascript:gotoReqBoxInfoView('<%= (String)objRs.getObject("REQ_BOX_STT") %>', '<%= (String)objRs.getObject("REQ_BOX_ID") %>')"><img src="/image/reqsubmit/icon_secretariat.gif" border="0" alt="<%=objRs.getObject("REQ_BOX_NM")%> 바로가기"></a></td>
                	...
                	<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    	<tr> 
                      		<td width="256" height="40">
                      			...
                      			%>
                      			<img src="/image/button/bt_putBinder.gif" height="20"  style="cursor:hand" onClick="javascript:addBinder(listForm);" alt="선택된 문서를 바인더 요구함에 등록하여 바인딩할 수 있도록 합니다.">
                      			<%
                      			 }//endif 바인딩할것이있어야하지..
                      			%>
                      		</td>
