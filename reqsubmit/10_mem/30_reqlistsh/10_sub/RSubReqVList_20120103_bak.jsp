  ...
  <div id="container">
    ...
    <div id="rightCon">
      ...
      <div id="pgTit" style="background:url(/images2/foundation/stl_bg02.gif) no-repeat left top;">
        ...
        <p>제출기관에서 답변한 요구 정보를 확인하는 화면입니다. </p>
      </div>
      <!-- /pgTit -->
		...
		%>
		 ...
		 <% } %>
            ...
            <tr>
                ...
                <th height="25" width="149">&bull;&nbsp;답변일시</th>
...
-->
		...
		%>
			 ...
			 <span class="list_bt"><a href="appointCmtReq()">추가 답변 요구</a></span>
		<%
						}
		...
		%>
			 <span class="list_bt"><a href="#" onclick="requestAddAnswer()">추가 답변 요구</a></span>
		...
		%>
			 <span class="list_bt"><a href="#" onclick="viewReqHistory('<%=objParams.getParamValue("ReqInfoID")%>')">요구 이력 조회</a></span>
			 <span class="list_bt"><a href="#" onclick="gotoList()">요구목록</a></span>
		 </div>
