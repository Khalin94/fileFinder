...
<form name="formName" method="get" action="<%=request.getRequestURI()%>"><!--요구함 신규정보 전달 -->
      ...
      <div id="pgTit" style="background:url(/images2/foundation/stl_bg02.gif) no-repeat left top;">
        ...
        <p>제출기관에서 아직 답변하지않은 요구 정보를 확인하는 화면입니다. </p>
      </div>
      <!-- /pgTit -->
      ...
      <div id="contents">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="680" class="list02">
            ...
            <tr>
                ...
                <td height="25" colspan="3">- <%=nads.dsdm.app.reqsubmit.delegate.requestinfo.RequestInfoDelegate.getAppendRequestInfo((List)objInfoRsSH.getObject("TBDS_REQ_LOG"))%>
				</td>
            </tr>
		<%
		...
		%>
		 ...
		 <% } %>
            ...
            <tr>
                ...
                <td height="25"><%=(String)objInfoRsSH.getObject("REQ_ORGAN_NM")%> (<%=(String)objInfoRsSH.getObject("REGR_NM")%>)</td>
            ...
            <tr>
                ...
                <th height="25" width="149">&bull;&nbsp;요구일시</th>
            ...
            <tr>
                ...
                <th height="25" width="149">&bull;&nbsp;위원회 제출상태</th>
...
-->
		...
		%>
			 <span class="list_bt"><a href="#" onclick="appointCmtReq()">위원회 제출 신청</a></span>
		<%
					}
				}
		%>
			 <span class="list_bt"><a href="#" onclick="gotoEditPage()">공개 설정 저장</a></span>
		<%
			} // end if check status
		%>
			 <span class="list_bt"><a href="#" onclick="viewReqHistory('<%=objParams.getParamValue("ReqInfoID")%>')">요구 이력 보기</a></span>
			 <span class="list_bt"><a href="#" onclick="gotoList()">요구 목록</a></span>
		 </div>
