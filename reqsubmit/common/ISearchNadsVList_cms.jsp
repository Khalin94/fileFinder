...
<div class="popup">
				...
				<table border="0" cellspacing="0" cellpadding="0" class="list01">
					<thead>
						<tr>
							...
							<th scope="col">NO</th>
							<th style="width:350px; " scope="col"><a href="#">제출의견</a></th>
							<th scope="col"><a href="#">작성자</a></th>
							<th scope="col">공개</th> 
							<th scope="col"><a href="#">답변</a></th>

							<th scope="col"><a href="#">답변일<img src="/images2/btn/bt_td.gif" width="11" height="11" alt="" /></a></th>
    ...
    <!-- 리스트 버튼-->
    <div id="btn_all"  class="t_right"><span class="list_bt"><a href="#" onClick="closeWindows()">창닫기</a></span>&nbsp;&nbsp; </div>
