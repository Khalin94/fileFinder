...
<%
 ...
 /*************************************************************************************************/
  ...
  //(2015.06.18) String strAnsApprStt=(String)request.getParameter("ANSW_PERM_CD");
...
/*(2015.06.18)  if(!StringUtil.isAssigned(strAnsApprStt)){
  	blnFlag=false;
...
<%
 ...
 try{
   ...
   //(2015.06.18) blnEditOk2 =((Boolean)objReqInfo.changeAnsApprStt(strReqInfoID,strAnsApprStt)).booleanValue();
   //(2015.06.18) if(!blnEditOk||!blnEditOk2){
   if(!blnEditOk) {
 	objMsgBean.setMsgType(MessageBean.TYPE_WARN);
