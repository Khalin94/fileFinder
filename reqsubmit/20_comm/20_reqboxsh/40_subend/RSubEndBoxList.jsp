...
<form name="listqry" method="post" action="<%=request.getRequestURI()%>">
      ...
      <div id="pgTit" style="background:url(/images2/foundation/stl_bg02.gif) no-repeat left top;">
        <h3><%=MenuConstants.COMM_REQ_BOX_SUBMT_END%><span class="sub_stl" >- 요구함 목록</span></h3>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="list01">
          <thead>
            <tr>
              ...
              <th scope="col"><%=SortingUtil.getSortLink("changeSortQuery","REQ_BOX_NM",strCommReqBoxSortField,strCommReqBoxSortMtd,"요구함명")%></th>
              ...
              <th scope="col"><%=SortingUtil.getSortLink("changeSortQuery","LAST_ANS_DOC_SND_DT",strCommReqBoxSortField,strCommReqBoxSortMtd, "제출일시")%></th>
            </tr>
          </thead>
          <tbody>
  			<%
			...
			%>
			<tr>
				<td colspan="6" align="center">등록된 요구함이 없습니다.</td>
			</tr>
			<%
				} // end if
			%>
