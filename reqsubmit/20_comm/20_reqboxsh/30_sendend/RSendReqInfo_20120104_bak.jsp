...
<form name="formName" method="post" action="">
	...
	%>
      ...
      <!-- pgTit -->
        ...
        <p>제출기관에게 발송한 요구정보를 확인하는 화면입니다. </p>
      </div>
      <!-- /pgTit -->
      ...
      <div id="contents">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="680" class="list02">
            ...
            <tr>
                ...
                <td height="25" width="220"><%=objRsSH.getObject("CMT_ORGAN_NM")%> </td>
                <th height="25" width="120">&bull;&nbsp;제출기관 </th>
                <td height="25" width="220"><%=(String)objRsSH.getObject("SUBMT_ORGAN_NM")%> </td>
            </tr>
            <tr>
                <th height="25" width="120">&bull; 접수시작 </th>
                <td height="25" width="220"><%=StringUtil.getDate((String)objRsSH.getObject("ACPT_BGN_DT"))%></td>
                <th height="25" width="120">&bull;&nbsp;접수마감 </th>
                <td height="25" width="220"><%=StringUtil.getDate((String)objRsSH.getObject("ACPT_END_DT"))%></td>
            </tr>
			 <tr>
                <th height="25" width="120">&bull; 등록일시 </th>
                <td height="25" width="220"><%=StringUtil.getDate2((String)objRsSH.getObject("REG_DT"))%></td>
                <th height="25" width="120">&bull;&nbsp;제출기한 </th>
                <td height="25" width="220"><%=StringUtil.getDate((String)objRsSH.getObject("SUBMT_DLN"))%> 24:00</td>
            </tr>
            <tr>
      ...
      <!--  <p class="warning mt10">* 요구서 발송 : 의원실(또는 소속기관) 명의로 해당 제출기관에 요구서를 발송합니다.</p>
        <!-- 리스트 버튼-->
         <div id="btn_all"class="t_right">
			 <span class="list_bt"><a href="javascript:viewReqHistory('<%=(String)request.getParameter("CommReqID")%>')">요구이력보기</a></span>
			 <span class="list_bt"><a href="javascript:gotoReqBox();">요구함보기</a></span>
		 </div>
