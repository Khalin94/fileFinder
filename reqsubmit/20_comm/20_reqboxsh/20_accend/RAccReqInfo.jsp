...
<!-- 상단버튼 끝  -->
		...
		%>
            ...
            <tr>
                ...
                <td height="25" width="32%"><%=CodeConstants.getOpenClass((String)objRsRI.getObject("OPEN_CL"))%></td>
                <th height="25" width="18%">&bull;&nbsp;등록일시</th>
                <td height="25" width="32%"><%=StringUtil.getDate((String)objRsSH.getObject("ACPT_BGN_DT"))%></td>
            </tr>
            <tr>
