	                    	...
	                    	<td>
	                    		<table width="759" border="0" cellspacing="0" cellpadding="0">
									<tr class="td_top">
										...
										<td width="385" align="center"><%=SortingUtil.getSortLink("changeSortQuery","REQ_CONT",strCommReqInfoSortField,strCommReqInfoSortMtd,"요구제목")%></td>
										<td width="100" align="center"><%=SortingUtil.getSortLink("changeSortQuery","OLD_REQ_ORGAN_NM",strCommReqInfoSortField,strCommReqInfoSortMtd,"요구기관")%></td>
							...
							<td>
								<table width="759" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td width="10" align="center"></td>	
										<% } %>
										<td width="34" class="td_lmagin" align="center" height="20"><%=intRecordNumber%></td>
										<td width="385" class="td_lmagin" style="padding-left:4px"><a href="JavaScript:gotoDetail('<%=strReqBoxID%>','<%=strReqInfoID%>');" hint="<%=StringUtil.substring((String)objRs.getObject("REQ_DTL_CONT"), 80)%>"><%=StringUtil.substring((String)objRs.getObject("REQ_CONT"),30)%></a></td>
										<td width="100" class="td_lmagin">
											<%
										...
										<td width="40" class="td_lmagin" align="center"><%=nads.lib.reqsubmit.util.DBAccessUtil.makeAnsInfoHtml((String)objRs.getObject("ANS_ID"),(String)objRs.getObject("ANS_MTD"),(String)objRs.getObject("ANS_OPIN"),(String)objRs.getObject("SUBMT_FLAG"),objUserInfo.isRequester())%></td>
										<td width="70" class="td_lmagin" align="right" style="padding-top:2px;padding-bottom:2px"><%=StringUtil.getDate2((String)objRs.getObject("LAST_REQ_DT"))%> </td>
										<td width="70" class="td_lmagin" align="right"><%=StringUtil.getDate2((String)objRs.getObject("LAST_ANS_DT"))%> </td>
									</tr>
								</table>
							</td>
						</tr>
