...
<%
	response.setHeader("Content-Disposition", "Statistics;filename=SelectAudit_Mem_Excel.xls");
	response.setHeader("Content-Description", "SelectAudit_Mem_Excel");
%>
...
<%
     ...
     try {
		objCommList = objStatics.select_Mem_Sys_Audit(AUDIT_YEAR, RLTD_GBN, COMM_GBN);
//		objCommList = objStatics.select_Mem_Sys_Audit("2004", "001", "TE00000001");
...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
	<table border="0" cellspacing="0" cellpadding="0">
		<tr align="center">
			<td colspan="6"><%=AUDIT_YEAR%>년 소속 의원실별 요구 현황 </td>
		</tr>
   	</table>
   	<br>
 	<table border="1" cellspacing="0" cellpadding="0">          
			<tr align="center">
			  <td width="23%" height="25" class="td0_2"  rowspan="2">의원실명</td>			
