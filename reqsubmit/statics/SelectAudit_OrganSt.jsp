...
//         alert(strComm_cd);                  
		 ...
		 location.href=window.open("SelectAudit_Organ_ExcelSt.jsp?strYear="+strYear+"&strRltd_cd="+strRltd_cd+"&strComm_cd="+strComm_cd);
      	 form1.submit();
         break;
  }
}
    ...
    <td width="973"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr bgcolor="EDEDED"> 
          <td height="25" colspan="2" align="left" valign="middle">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;홈 
            &gt; 통계 관리 &gt; 서류 요구 제출 통계 &gt; <strong>기관별 요구 현황</strong></td>
        </tr> 
        <tr> 
