...
<%
	response.setHeader("Content-Disposition", "Statistics;filename=SelectSystem_Mem_Excel.xls");
	response.setHeader("Content-Description", "SelectSystem_Mem_Excel");
%>
...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
	<table border="0" cellspacing="0" cellpadding="0">
		<tr align="center">
			<td colspan="6"><%=AUDIT_YEAR%>년 소속 의원실별 요구/제출 현황 </td>
		</tr>
   	</table>
   	<br>
