...
//         alert(strRltd_nm);                  
		 ...
		 location.href=window.open("SelectSystem_Comm_Excel.jsp?strYear="+strYear+"&strRltd_cd="+strRltd_cd);
      	 form1.submit();
         break;
  }
}
    ...
    <td width="973"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr bgcolor="EDEDED"> 
          <td height="25" colspan="2" align="left" valign="middle">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;홈 
            &gt; 통계 관리 &gt; 서류 요구 제출 통계 &gt; <strong>위원회별 요구/제출 현황</strong></td>
        </tr> 
        <tr> 
        ...
        <tr height="10"> 
          ...
          <td align="left" valign="top"><table width="95%"  border="0" cellpadding="0" cellspacing="1" bgcolor="F4F4F4">          
			<tr align="center">
			    <td width="25%" height="25" class="td0_2" rowspan="2">위원회명</td>
