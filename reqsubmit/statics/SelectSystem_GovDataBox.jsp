...
//         alert(strRltd_nm);                  
		 ...
		 location.href=window.open("SelectSystem_GovDataBox_Excel.jsp?strYear="+strYear+"&strRltd_cd="+strRltd_cd);
      	 form1.submit();
         break;
  }
}
    ...
    <td width="973"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr bgcolor="EDEDED"> 
          <td height="25" colspan="2" align="left" valign="middle">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;홈 
            &gt; 통계 관리 &gt; 서류 요구 제출 통계 &gt; <strong>정부제출자료함</strong></td>
        </tr> 
        <tr> 
					       ...
					       <select name="year_cd">
								...
								<%   //년도를 셋팅해준다.
								        if (objYear != null) {
											...
											String strYear = (String)objAUDIT_YEAR.get("GOV_YEAR");
								%>
        ...
        <tr height="10"> 
          ...
          <td align="left" valign="top"><table width="95%"  border="0" cellpadding="0" cellspacing="1" bgcolor="F4F4F4">          
			<tr align="center">			
				<td width="40%" height="25" class="td0_2" >제출기관</td>
				<td width="30%" height="25" class="td0_2" >총 제출건수</td>
				<td width="30%" height="25" class="td0_2" >입통연계건수</td>
			</tr>              
<%
		int j = 1;
		if( j != objGovList.size()) {
			for (int i = 0; i < objGovList.size(); i++) {
				Hashtable objHGovList = (Hashtable)objGovList.get(i);
				if( i < objGovList.size() - 1) {
%>
			<tr align="center">
				<td height="20" bgcolor="FFFFFF" class="td0_1">&nbsp;<%=objHGovList.get("ORGAN_NM")%></td>
				<td height="20" bgcolor="ffffff">&nbsp;<%=objHGovList.get("SEND_CNT")%></td>
				<td height="20" bgcolor="ffffff">&nbsp;<%=objHGovList.get("CONN_CNT")%></td>			
			</tr>
			<%}else{%>
			<tr align="center">
				<td height="20" bgcolor="DDDDDD">&nbsp;<%=objHGovList.get("ORGAN_NM")%></td>
				<td height="20" bgcolor="#EFEFEF">&nbsp;<%=objHGovList.get("SEND_CNT")%></td>
				<td height="20" bgcolor="#EFEFEF">&nbsp;<%=objHGovList.get("CONN_CNT")%></td>			
			</tr>	
			<%}%>          							
		<%}%>          										
	<%}else{%>
			<tr align="center">
            	<td height="20" colspan="3" >해당 조건에 제출된 정보가 없습니다.</td>				
			</tr>			
<%}%>          				
