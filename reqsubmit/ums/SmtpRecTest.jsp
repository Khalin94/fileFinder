	...
	<table border="0" cellpadding="0" cellspacing="0" width="980" height="500">
		...
		<tr>
			...
			<td width="790" valign="top">
				...
				<td>
				<table>
				<form name="form1" method="post" action="SmtpProc.jsp">
						...
						<td>
						  <table>
						    ...
						    <tr> 
						      ...
						      <td colspan="2">
   						        <input type="text" class="textbox" name="rmail" size="30"  value="qaz@v.com">
						      </td>
						    </tr>	
				 		    <tr>
				 		    </tr>
						    ...
						    <tr> 
						      ...
						      <td colspan="2">
   						        <input type="text" class="textbox" name="smail" size="30"  value="zzz@z.com">
						      </td>
						    </tr>						    						    
						    <tr> 
						      <td bgcolor="#CCCCCC" align="center"><b>제목</b></td>
						      <td colspan="2">
   						        <input type="text" class="textbox" name="subject" size="30"  value="제목">
						      </td>
						    </tr>						    						    
						    <tr> 
						      <td bgcolor="#CCCCCC" align="center"><b>내용</b></td>						      
						      <td colspan="2">
						        <TEXTAREA  name="contents" cols="103" rows="8" value=""></TEXTAREA>        
						      </td>						      						      
						    </tr>						    						    						    						        						    
						    <tr> 
